...
//void Batch_5_1(Int_t Run_Number=5, Int_t ievt_min=2, Int_t ievt_max=2, Int_t Switch_Display=0){
void Batch_5_1(Int_t Run_Number=5, Int_t Switch_Display=0, Int_t ievt=-1){
  ...
  //////////////////////////////////////////////////////////////////////////////////
    ...
    int Read_Run_Number;
      ...
      //char output[100];
      //sprintf(output,"output_Test.txt");
      //ofstream fout;
      //fout.open(output);
  ...
  //ifstream fdat_read("/media/bianchin/hdd1/trek/E36/TEST/offline_new/sandbox/Keito_run_3994_1.txt", ios::in);
  ...
  sprintf(output,"RUN_%d_DATA_batch.txt",Run_Number);
  ofstream fout;
  fout.open(output);
  ...
  while(ievt < 1000){
    ...
    if(Switch_Display==0 && counter%10000==0) cout << "****  " << counter << " events done!" << endl;
  ...
  */
   ...
   for(int i=0; i<256; i++) TARGET_High_has_neighbours[i] = false;
    ...
    a_test_lepton_fit = 999.99;          a_test_kaon_fit = 999.99;
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    cout << x_int_TARGET[0] << " " << x_int_TARGET[1] << " " << y_int_TARGET[0] << " " << y_int_TARGET[1];
    ...
    */
    ...
    if(Switch_Display==1){
      if(ndf!=3){
        ...
        else nan_evts.push_back(Read_Run_Number);
      }
    }
