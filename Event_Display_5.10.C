...
void Event_Display_5_9(Int_t Run_Number=5, Int_t ievt=0, int walk=0, Int_t enable_cout=0, Int_t display = 0, Int_t graphics = 1, Int_t batch = 0){
  ...
  for(Int_t ivt=ievt; ivt<ievt+1; ivt++){
    auto t1 = std::chrono::high_resolution_clock::now();
    cout << "Ivt is " << ievt << ", " << ivt << endl;
    fChain.GetEntry(ivt);
    ...
    cout << "count_TARGET_evts: " << count_TARGET_evts << endl;
    // for (int i = 0; i < 256; ++i) {
    //   cout << adc_high_target[i] << " ";
    // }
    // cout << endl;
    ...
    // for (int i = 0; i < 256; ++i) {
    //   cout << ADC_High_TARGET[i] << " ";
    //   if (ADC_High_TARGET[i]>0) {
    //     ++count_ADC;
    //   }
    // }
    // cout << "count_ADC " << count_ADC;
    // cout << endl;
    // for (int i = 0; i < 256; ++i) {
    //   cout << tdc_le_target[i][0] << " ";
    // }
    // cout << endl;
    // for (int i = 0; i < 256; ++i) {
    //   cout << tdc_le_target[i][1] << " ";
    // }
    // cout << endl;
    // for (int i = 0; i < 256; ++i) {
    //   cout << tdc_le_target[i][2] << " ";
    // }
    // cout << endl;
    // for (int i = 0; i < 256; ++i) {
    //   cout << tdc_le_target[i][3] << " ";
    // }
    // cout << endl;
    // for (int i = 0; i < 256; ++i) {
    //   cout << ADC_Low_TARGET[i] << " ";
    // }
    // cout << endl;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if (has_data_ADC3 > 1){
    ...
    if (has_data_ADCA > 2){
      ...
      if (graphics == 1) {
        ...
        TLatex *tex_angle_ADC=new TLatex(0,-9,angle_string_ADC);
  ...
  TGraphErrors gr3_Leptons_rotate = TGraphErrors(vec_xx_lepton_rotate.size(),&vec_xx_lepton_rotate[0],&vec_yy_lepton_rotate[0],
  ...
  /////////////////////////////////////////////////////////////////////////////////
    ...
    // delete gr_kaon_fit;
    // delete x_guide;
    // delete y_guide; delete x_guide_rotate;
  ...
  ofstream fout;
  fout.open("output_Batch_5.10.txt", ios::app);
