...
//void SFT_Test_CR_Event(int Run_Number, int evt, double phi, int gap_to_fit, bool to_print, double C2X_centroid, double length_in_target); 

void Event_Display_2_3(Int_t Run_Number=5, Int_t ievt=0, Int_t enable_cout=0, Int_t display_fits = 0){ 
  ...
  int MWPC_switch = 1; // Display wire chamber hits (0 = OFF ; 1 = ON)
  ...
  //const double Offset_TOP[6] = {430., 180., 410, 0., 0., 390.};  //NEW
  //const double Offset_BOTTOM[6] = {280., -30., 70., 0., 0., 310.};
  //const double Slope_correction_TOP[6] = {0.78, 0.70, 0.78, 1., 1., 0.67};
  //const double Slope_correction_BOTTOM[6] = {0.60, 0.86, 0.77, 1., 1., 0.7};
 ...
 /////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //TOF_line1->SetLineWidth(10);
  //TOF_line2->SetLineWidth(10);
  //TOF_line3->SetLineWidth(10);
  //TOF_line4->SetLineWidth(10);
  //TOF_line5->SetLineWidth(10);
  //TOF_line6->SetLineWidth(10);
  //TOF_line7->SetLineWidth(10);
  //TOF_line8->SetLineWidth(10);
  //TOF_line9->SetLineWidth(10);
  //TOF_line10->SetLineWidth(10);
  //TOF_line11->SetLineWidth(10);
  //TOF_line12->SetLineWidth(10);
 ...
 /////////////////////////////////////////////////////////////////
  ...
  Int_t TDC_max_TARGET = kaon_TDC_max;
  ...
  cout << "TDC 49:  " << tdc_le_target[49][0] << "  " << TDC_min_Kstop << "  " << TDC_max_Kstop << endl;
  cout << "TDC 49:  " << tdc_le_target[49][1] << "  " << TDC_min_Kstop << "  " << TDC_max_Kstop << endl;
  cout << "TDC 49:  " << tdc_le_target[49][2] << "  " << TDC_min_Kstop << "  " << TDC_max_Kstop << endl;
  cout << "TDC 49:  " << tdc_le_target[49][3] << "  " << TDC_min_Kstop << "  " << TDC_max_Kstop << endl;
  cout << "TDC 49:  " << tdc_le_target[49][4] << "  " << TDC_min_Kstop << "  " << TDC_max_Kstop << endl;
  cout << "TDC 49:  " << tdc_le_target[49][5] << "  " << TDC_min_Kstop << "  " << TDC_max_Kstop << endl;
  cout << "TDC 49:  " << tdc_le_target[49][6] << "  " << TDC_min_Kstop << "  " << TDC_max_Kstop << endl;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //if (has_both_ADC_TOF1_hit[0] && !has_TDC_TOF1_hit[0] && 
  //((has_ADC_TOF2_hit[11] && has_TDC_TOF2_hit[11]) || (has_ADC_TOF2_hit[0] && has_TDC_TOF2_hit[0]) || (has_ADC_TOF2_hit[1] && has_TDC_TOF2_hit[1]))) TOF_line1->SetLineColor(kYellow);
  ...
  //if (has_both_ADC_TOF1_hit[1] && !has_TDC_TOF1_hit[1] && 
  // ((has_ADC_TOF2_hit[0] && has_TDC_TOF2_hit[0]) || (has_ADC_TOF2_hit[1] && has_TDC_TOF2_hit[1]) || (has_ADC_TOF2_hit[2] && has_TDC_TOF2_hit[2]))) TOF_line2->SetLineColor(kYellow);
  ...
  //if (has_both_ADC_TOF1_hit[2] && !has_TDC_TOF1_hit[2] && 
  // ((has_ADC_TOF2_hit[1] && has_TDC_TOF2_hit[1]) || (has_ADC_TOF2_hit[2] && has_TDC_TOF2_hit[2]) || (has_ADC_TOF2_hit[3] && has_TDC_TOF2_hit[3]))) TOF_line3->SetLineColor(kYellow);
  ...
  //if (has_both_ADC_TOF1_hit[3] && !has_TDC_TOF1_hit[3] && 
  // ((has_ADC_TOF2_hit[2] && has_TDC_TOF2_hit[2]) || (has_ADC_TOF2_hit[3] && has_TDC_TOF2_hit[3]) || (has_ADC_TOF2_hit[4] && has_TDC_TOF2_hit[4]))) TOF_line4->SetLineColor(kYellow);
  ...
  //if (has_both_ADC_TOF1_hit[4] && !has_TDC_TOF1_hit[4] && 
  // ((has_ADC_TOF2_hit[3] && has_TDC_TOF2_hit[3]) || (has_ADC_TOF2_hit[4] && has_TDC_TOF2_hit[4]) || (has_ADC_TOF2_hit[5] && has_TDC_TOF2_hit[5]))) TOF_line5->SetLineColor(kYellow);
  ...
  //if (has_both_ADC_TOF1_hit[5] && !has_TDC_TOF1_hit[5] && 
  // ((has_ADC_TOF2_hit[4] && has_TDC_TOF2_hit[4]) || (has_ADC_TOF2_hit[5] && has_TDC_TOF2_hit[5]) || (has_ADC_TOF2_hit[6] && has_TDC_TOF2_hit[6]))) TOF_line6->SetLineColor(kYellow);
  ...
  //if (has_both_ADC_TOF1_hit[6] && !has_TDC_TOF1_hit[6] && 
  // ((has_ADC_TOF2_hit[5] && has_TDC_TOF2_hit[5]) || (has_ADC_TOF2_hit[6] && has_TDC_TOF2_hit[6]) || (has_ADC_TOF2_hit[7] && has_TDC_TOF2_hit[7]))) TOF_line7->SetLineColor(kYellow);
  ...
  //if (has_both_ADC_TOF1_hit[7] && !has_TDC_TOF1_hit[7] && 
  // ((has_ADC_TOF2_hit[6] && has_TDC_TOF2_hit[6]) || (has_ADC_TOF2_hit[7] && has_TDC_TOF2_hit[7]) || (has_ADC_TOF2_hit[8] && has_TDC_TOF2_hit[8]))) TOF_line8->SetLineColor(kYellow);
  ...
  //if (has_both_ADC_TOF1_hit[8] && !has_TDC_TOF1_hit[8] && 
  // ((has_ADC_TOF2_hit[7] && has_TDC_TOF2_hit[7]) || (has_ADC_TOF2_hit[8] && has_TDC_TOF2_hit[8]) || (has_ADC_TOF2_hit[9] && has_TDC_TOF2_hit[9]))) TOF_line9->SetLineColor(kYellow);
  ...
  //if (has_both_ADC_TOF1_hit[9] && !has_TDC_TOF1_hit[9] && 
  // ((has_ADC_TOF2_hit[8] && has_TDC_TOF2_hit[8]) || (has_ADC_TOF2_hit[9] && has_TDC_TOF2_hit[9]) || (has_ADC_TOF2_hit[10] && has_TDC_TOF2_hit[10]))) TOF_line10->SetLineColor(kYellow);
  ...
  //if (has_both_ADC_TOF1_hit[10] && !has_TDC_TOF1_hit[10] && 
  // ((has_ADC_TOF2_hit[9] && has_TDC_TOF2_hit[9]) || (has_ADC_TOF2_hit[10] && has_TDC_TOF2_hit[10]) || (has_ADC_TOF2_hit[11] && has_TDC_TOF2_hit[11]))) TOF_line11->SetLineColor(kYellow);
  ...
  //if (has_both_ADC_TOF1_hit[11] && !has_TDC_TOF1_hit[11] && 
  // ((has_ADC_TOF2_hit[10] && has_TDC_TOF2_hit[10]) || (has_ADC_TOF2_hit[11] && has_TDC_TOF2_hit[11]) || (has_ADC_TOF2_hit[0] && has_TDC_TOF2_hit[0]))) TOF_line12->SetLineColor(kYellow);
  ...
  if(scoring_type==2){
    ...
    for(int i=0; i<12; i++){
      if(ADC_TOF1D[i]>=0){
        gap_counter[i]++;
        //cout << "DEBUG SCORE TOF1D: " << i << endl;
     }
    }

    for(int i=0; i<12; i++){
      if(TDC_TOF1U[i]>=TOF1U_TDC_min[i] && TDC_TOF1U[i]<=TOF1U_TDC_max[i]){
        //cout << "DEBUG SCORE TOF1U TDC: " << i << endl;
        gap_counter[i]++; 
     }
    }
    ...
    for(int i=0; i<12; i++){
      if(TDC_TOF1D[i]>=TOF1D_TDC_min[i] && TDC_TOF1D[i]<=TOF1D_TDC_max[i]){
        //cout << "DEBUG SCORE TOF1D TDC: " << i << endl;
        gap_counter[i]++;
      }
    }
    ...
    for(int i=0; i<12; i++){
      if(i!=0 && i!=11 && gap_counter[i]>0){
        ...
        if(ADC_TOF2AO[i]>=0){
          //cout << "DEBUG SCORE TOF2AO[i] ADC: " << i << endl;
          gap_counter[i]++;
        }

        if(ADC_TOF2AO[i-1]>=0){
          //cout << "DEBUG SCORE TOF2AO[i-1] ADC: " << i << endl;
          gap_counter[i]++;
        }
        ...
        if(ADC_TOF2AI[i]>=0){
          //cout << "DEBUG SCORE TOF2AI[i] ADC: " << i << endl;
          gap_counter[i]++;
        }

        if(ADC_TOF2AI[i-1]>=0){
          //cout << "DEBUG SCORE TOF2AI[i-1] ADC: " << i << endl;
          gap_counter[i]++;
        }
        ...
        if(ADC_TOF2BO[i]>=0){
          //cout << "DEBUG SCORE TOF2BO[i] ADC: " << i << endl;
        	gap_counter[i]++;
        }

        if(ADC_TOF2BO[i-1]>=0){
          //cout << "DEBUG SCORE TOF2BO[i-1] ADC: " << i << endl;
        	gap_counter[i]++;
        }
        ...
        if(ADC_TOF2BI[i]>=0){
          //cout << "DEBUG SCORE TOF2BI[i] ADC: " << i << endl;
        	gap_counter[i]++;
        }

        if(ADC_TOF2BI[i-1]>=0){
          //cout << "DEBUG SCORE TOF2BI[i-1] ADC: " << i << endl;
        	gap_counter[i]++;
        }
        ...
        if(TDC_TOF2AO[i]>=TOF2AO_TDC_min[i] && TDC_TOF2AO[i]<=TOF2AO_TDC_max[i]){
          //cout << "DEBUG SCORE TOF2AO[i] TDC: " << i << endl;
        	gap_counter[i]++;   
        }

        if(TDC_TOF2AO[i-1]>=TOF2AO_TDC_min[i-1] && TDC_TOF2AO[i-1]<=TOF2AO_TDC_max[i-1]){
          //cout << "DEBUG SCORE TOF2AO[i-1] TDC: " << i << endl;
        	gap_counter[i]++;   
        }
        ...
        if(TDC_TOF2AI[i]>=TOF2AI_TDC_min[i] && TDC_TOF2AI[i]<=TOF2AI_TDC_max[i]){
          //cout << "DEBUG SCORE TOF2AI[i] TDC: " << i << endl;
        	gap_counter[i]++;   
        }

        if(TDC_TOF2AI[i-1]>=TOF2AI_TDC_min[i-1] && TDC_TOF2AI[i-1]<=TOF2AI_TDC_max[i-1]){
          //cout << "DEBUG SCORE TOF2AI[i-1] TDC: " << i << endl;
        	gap_counter[i]++;  
        }
        ...
        if(TDC_TOF2BO[i]>=TOF2BO_TDC_min[i] && TDC_TOF2BO[i]<=TOF2BO_TDC_max[i]){
          //cout << "DEBUG SCORE TOF2BO[i] TDC: " << i << endl;
        	gap_counter[i]++;   
        }

        if(TDC_TOF2BO[i-1]>=TOF2BO_TDC_min[i-1] && TDC_TOF2BO[i-1]<=TOF2BO_TDC_max[i-1]){
          //cout << "DEBUG SCORE TOF2BO[i-1] TDC: " << i << endl;
        	gap_counter[i]++;   
        }
        ...
        if(TDC_TOF2BI[i]>=TOF2BI_TDC_min[i] && TDC_TOF2BI[i]<=TOF2BI_TDC_max[i]){
          //cout << "DEBUG SCORE TOF2BI[i] TDC: " << i << endl;
        	gap_counter[i]++;  
        }

        if(TDC_TOF2BI[i-1]>=TOF2BI_TDC_min[i-1] && TDC_TOF2BI[i-1]<=TOF2BI_TDC_max[i-1]){
          //cout << "DEBUG SCORE TOF2BI[i-1] TDC: " << i << endl;
        	gap_counter[i]++;   
        }
    ...
    if(gap_counter[0]>0){
      if(ADC_TOF2AO[0]>=0){
        //cout << "DEBUG SCORE TOF2AO[0] ADC  +1 " << endl;
        gap_counter[0]++;
      }

      if(ADC_TOF2AO[1]>=0){
        //cout << "DEBUG SCORE TOF2AO[1] ADC:  +1 " << endl;
        gap_counter[0]++;
      }

      if(ADC_TOF2AO[11]>=0){
        //cout << "DEBUG SCORE TOF2AO[11] ADC:  +1" << endl;
        gap_counter[0]++;
      }

      if(ADC_TOF2AI[0]>=0){
        //cout << "DEBUG SCORE TOF2AI[0] ADC  +1 " << endl;
        gap_counter[0]++;
      }

      if(ADC_TOF2AI[1]>=0){
        //cout << "DEBUG SCORE TOF2AI[1] ADC  +1 " << endl;
        gap_counter[0]++;
      }

      if(ADC_TOF2AI[11]>=0){
        //cout << "DEBUG SCORE TOF2AI[11] ADC  +1 " << endl;
        gap_counter[0]++;
      }  

      if(ADC_TOF2BO[0]>=0){
        //cout << "DEBUG SCORE TOF2BO[0] ADC  +1 " << endl;
        gap_counter[0]++;
      }

      if(ADC_TOF2BO[1]>=0){
        //cout << "DEBUG SCORE TOF2BO[1] ADC  +1 " << endl;
        gap_counter[0]++;
      }

      if(ADC_TOF2BO[11]>=0){
        //cout << "DEBUG SCORE TOF2BO[11] ADC  +1 " << endl;
        gap_counter[0]++;
      }   

      if(ADC_TOF2BI[0]>=0){
        //cout << "DEBUG SCORE TOF2BI[0] ADC  +1 " << endl;
        gap_counter[0]++;
      }

      if(ADC_TOF2BI[1]>=0){
        //cout << "DEBUG SCORE TOF2BI[1] ADC  +1 " << endl;
        gap_counter[0]++;
      }

      if(ADC_TOF2BI[11]>=0){
        //cout << "DEBUG SCORE TOF2BI[11] ADC  +1 " << endl;
        gap_counter[0]++;
      }

      if(TDC_TOF2AO[0]>=TOF2AO_TDC_min[0] && TDC_TOF2AO[0]<=TOF2AO_TDC_max[0]){
        //cout << "DEBUG SCORE TOF2AO[0] TDC  +1 " << endl;
        gap_counter[0]++;
      }

      if(TDC_TOF2AO[1]>=TOF2AO_TDC_min[1] && TDC_TOF2AO[1]<=TOF2AO_TDC_max[1]){
        //cout << "DEBUG SCORE TOF2AO[1] TDC  +1 " << endl;
        gap_counter[0]++;
      }

      if(TDC_TOF2AO[11]>=TOF2AO_TDC_min[11] && TDC_TOF2AO[11]<=TOF2AO_TDC_max[11]){
        //cout << "DEBUG SCORE TOF2AO[11] TDC  +1 " << endl;
        gap_counter[0]++; 
      }  

      if(TDC_TOF2AI[0]>=TOF2AI_TDC_min[0] && TDC_TOF2AI[0]<=TOF2AI_TDC_max[0]){
        //cout << "DEBUG SCORE TOF2AI[0] TDC  +1 " << endl;
        gap_counter[0]++;
      }

      if(TDC_TOF2AI[1]>=TOF2AI_TDC_min[1] && TDC_TOF2AI[1]<=TOF2AI_TDC_max[1]){
        //cout << "DEBUG SCORE TOF2AI[1] TDC  +1 " << endl;
        gap_counter[0]++;
      }

      if(TDC_TOF2AI[11]>=TOF2AI_TDC_min[11] && TDC_TOF2AI[11]<=TOF2AI_TDC_max[11]){
        //cout << "DEBUG SCORE TOF2AI[11] TDC  +1 " << endl;
        gap_counter[0]++;
      }   

      if(TDC_TOF2BO[0]>=TOF2BO_TDC_min[0] && TDC_TOF2BO[0]<=TOF2BO_TDC_max[0]){
        //cout << "DEBUG SCORE TOF2BO[0] TDC  +1 " << endl;
        gap_counter[0]++;
      }

      if(TDC_TOF2BO[1]>=TOF2BO_TDC_min[1] && TDC_TOF2BO[1]<=TOF2BO_TDC_max[1]){
        //cout << "DEBUG SCORE TOF2BO[1] TDC  +1 " << endl;
        gap_counter[0]++;
      }

      if(TDC_TOF2BO[11]>=TOF2BO_TDC_min[11] && TDC_TOF2BO[11]<=TOF2BO_TDC_max[11]){
        //cout << "DEBUG SCORE TOF2BO[11] TDC  +1 " << endl;
        gap_counter[0]++;
      }   

      if(TDC_TOF2BI[0]>=TOF2BI_TDC_min[0] && TDC_TOF2BI[0]<=TOF2BI_TDC_max[0]){
        //cout << "DEBUG SCORE TOF2BI[0] TDC  +1 " << endl;
        gap_counter[0]++;
      }

      if(TDC_TOF2BI[1]>=TOF2BI_TDC_min[1] && TDC_TOF2BI[1]<=TOF2BI_TDC_max[1]){
        //cout << "DEBUG SCORE TOF2BI[1] TDC  +1 " << endl;
        gap_counter[0]++;
      }   

      if(TDC_TOF2BI[11]>=TOF2BI_TDC_min[11] && TDC_TOF2BI[11]<=TOF2BI_TDC_max[11]){
        //cout << "DEBUG SCORE TOF2BI[11] TDC  +1 " << endl;
        gap_counter[0]++;
      }  
    }
  ...
  //for(unsigned int i=0; i<tof1_ties.size(); i++) cout << "SSS:  " << i << "   " << tof1_ties[i] << endl;
  //cout << "DEBUG : " << gap_to_fit << endl;


  //cout << "tdc_tof1u_min :   " << tdc_tof1u_min	<< endl;
  //cout << "tdc_tof1d_min :   " << tdc_tof1d_min	<< endl;
  
  //cout << "TDC_TOF1U[8] :  " << TDC_TOF1U[8] << endl;
  //cout << "TDC_TOF1D[8] :  " << TDC_TOF1D[8] << endl;
  //cout << endl;
  //cout << "TDC_TOF1U[9] :  " << TDC_TOF1U[9] << endl;
  //cout << "TDC_TOF1D[9] :  " << TDC_TOF1D[9] << endl;
  //cout << endl;
  //cout << "ADC_TOF1U[8] :  " << ADC_TOF1U[8] << endl;
  //cout << "ADC_TOF1D[8] :  " << ADC_TOF1D[8] << endl;
  //cout << endl;
  //cout << "ADC_TOF1U[9] :  " << ADC_TOF1U[9] << endl;
  //cout << "ADC_TOF1D[9] :  " << ADC_TOF1D[9] << endl;
  ...
  //cout << "DEBUG BEFORE :  " << gap_counter[2] << endl;
  //cout << "SIZE : " << tof1_ties.size() << endl;
  ...
  if(tof1_ties.size() > 1){  // only when there are more than 2 elements in tof1_ties!
    ...
    //cout << "DEBUG AFTER : " << gap_counter[2] << endl;
  ...
  //cout << "PAPA:   " << gap_to_fit << "    " << score_max << endl;



  //cout << "FFFF:  " << gap_to_fit << endl;
  ...
  if(TARGET_High_has_neighbours[i]){
      ...
      if(ADC_High_TARGET[i]<0 && ADC_Low_TARGET[i]>0 && Switch==1){
        if(!k_stop_bar[i]) h_TDC_Gap_Fibers->Fill(Xloc[i],Yloc[i]);
 ...
 // ICI
  ...
  if(Good_Event && enable_cout==1){
    ...
    //cout << "ADC Threshold Offset (LG): " << TARGET_ADC_Thr_LG_Offset << endl;
  ...
  //for(int i=0; i<56; i++){
  	//if(C2X_L[i]>0) cout << "C2XL  :   " << i << "   " << C2X_L[i] << endl;
  	//if(C2X_R[i]>0) cout << "C2XR  :   " << i << "   " << C2X_R[i] << endl;
  //}
  ...
  if(gap_to_fit>=7){ // LEFT
    ...
    for (int q = 240; q < 254; q++) { // RIGHT
      if (Good_Event && MWPCADC[q]>0) {
        cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
      }
    }
    for (int q = 208; q < 222; q++) { // RIGHT
      if (Good_Event && MWPCADC[q]>0) {
        cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
      }
    }
    for (int q = 176; q < 190; q++) { //RIGHT
      if (Good_Event && MWPCADC[q]>0) {
        cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
      }
    }
    for (int q = 144; q < 158; q++) { // RIGHT
      if (Good_Event && MWPCADC[q]>0) {
        cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
      }
    }

    for (int q = 112; q < 128; q++) { // RIGHT
      if (Good_Event && MWPCADC[q]>0) {
        cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
      }
    }
  ...
  */
  ...
  if(selected_TOF2 > 6){  // LEFT
    ...
    if(MWPC_switch==1){
      ...
      //palette_MWPC[0] = new TMarker(-6,16,21);     palette_MWPC[0]->SetMarkerColor(kOrange+10);    palette_MWPC[0]->SetMarkerSize(flag_size_palette_MWPC);
      //palette_MWPC[1] = new TMarker(-6,15,21);     palette_MWPC[1]->SetMarkerColor(kOrange+7);     palette_MWPC[1]->SetMarkerSize(flag_size_palette_MWPC);
      //palette_MWPC[2] = new TMarker(-6,14,21);     palette_MWPC[2]->SetMarkerColor(kOrange+1);     palette_MWPC[2]->SetMarkerSize(flag_size_palette_MWPC);
      //palette_MWPC[3] = new TMarker(-6,13,21);     palette_MWPC[3]->SetMarkerColor(kOrange-4);     palette_MWPC[3]->SetMarkerSize(flag_size_palette_MWPC);
      //palette_MWPC[4] = new TMarker(-6,12,21);     palette_MWPC[4]->SetMarkerColor(kYellow-9);     palette_MWPC[4]->SetMarkerSize(flag_size_palette_MWPC);
      //palette_MWPC[5] = new TMarker(-6,11,21);     palette_MWPC[5]->SetMarkerColor(kYellow-7);     palette_MWPC[5]->SetMarkerSize(flag_size_palette_MWPC);
      //palette_MWPC[6] = new TMarker(-6,10,21);     palette_MWPC[6]->SetMarkerColor(kYellow-0);     palette_MWPC[6]->SetMarkerSize(flag_size_palette_MWPC);
      //palette_MWPC[7] = new TMarker(-6,9,21);      palette_MWPC[7]->SetMarkerColor(kSpring-4);     palette_MWPC[7]->SetMarkerSize(flag_size_palette_MWPC);
      //palette_MWPC[8] = new TMarker(-6,8,21);      palette_MWPC[8]->SetMarkerColor(kSpring-2);     palette_MWPC[8]->SetMarkerSize(flag_size_palette_MWPC);
      //palette_MWPC[9] = new TMarker(-6,7,21);      palette_MWPC[9]->SetMarkerColor(kGreen-0);      palette_MWPC[9]->SetMarkerSize(flag_size_palette_MWPC);
	  

      //TLatex *tex_palette_MWPC_scale = new TLatex(-4,6,"x 100");                 tex_palette_MWPC_scale->SetTextSize(text_size_MWPC);
      //tex_palette_MWPC[0] = new TLatex(-4,14.5,ADC_palette_string_MWPC[0]);      tex_palette_MWPC[0]->SetTextSize(text_size_MWPC);
      //tex_palette_MWPC[1] = new TLatex(-4,13.5,ADC_palette_string_MWPC[1]);      tex_palette_MWPC[1]->SetTextSize(text_size_MWPC);
      //tex_palette_MWPC[2] = new TLatex(-4,12.5,ADC_palette_string_MWPC[2]);      tex_palette_MWPC[2]->SetTextSize(text_size_MWPC);
      //tex_palette_MWPC[3] = new TLatex(-4,11.5,ADC_palette_string_MWPC[3]);      tex_palette_MWPC[3]->SetTextSize(text_size_MWPC);
      //tex_palette_MWPC[4] = new TLatex(-4,10.5,ADC_palette_string_MWPC[4]);      tex_palette_MWPC[4]->SetTextSize(text_size_MWPC);
      //tex_palette_MWPC[5] = new TLatex(-4,9.5,ADC_palette_string_MWPC[5]);       tex_palette_MWPC[5]->SetTextSize(text_size_MWPC);
      //tex_palette_MWPC[6] = new TLatex(-4,8.5,ADC_palette_string_MWPC[6]);       tex_palette_MWPC[6]->SetTextSize(text_size_MWPC);
      //tex_palette_MWPC[7] = new TLatex(-4,7.5,ADC_palette_string_MWPC[7]);       tex_palette_MWPC[7]->SetTextSize(text_size_MWPC);
      //tex_palette_MWPC[8] = new TLatex(-4,6.5,ADC_palette_string_MWPC[8]);       tex_palette_MWPC[8]->SetTextSize(text_size_MWPC);
      //tex_palette_MWPC[9] = new TLatex(-4,5.5,ADC_palette_string_MWPC[9]);       tex_palette_MWPC[9]->SetTextSize(text_size_MWPC);
  ...
  int TDC_Cpi_counter = 0;
    ...
    cout << endl;
    cout << "N(C_k) = " << TDC_Ck_counter << endl;
    cout << "N(C_pi) =  " << TDC_Cpi_counter << endl << endl;
 ...
 ///////////////////////////////////////////////////////// K STOP CENTROID END
  ...
  h_int_TDC_SFT->SetMarkerStyle(20);        h_int_TDC_TARGET->SetMarkerStyle(20);
  h_int_TDC_SFT->SetMarkerColor(1);         h_int_TDC_TARGET->SetMarkerColor(1);
  h_int_TDC_SFT->SetMarkerSize(0.8);        h_int_TDC_TARGET->SetMarkerSize(0.8);
  ...
  double Dummy_ChiS;
  double Dummy_ndf;
  double Dummy_red_ChiS;
  double Dummy_Prob;

  TH2F *h_dummy = new TH2F("dummy", "dummy", 500, -50, 50, 500, -50, 50);
    h_dummy->Fill(double(0),double(0));
    h_dummy->Fill(double(2),double(2));
    h_dummy->Fill(double(4),double(4));
    h_dummy->Fill(double(6),double(6));
    h_dummy->Fill(double(7),double(8));
    h_dummy->Fill(double(10),double(10));
    h_dummy->Fill(double(12),double(12));
    h_dummy->Fill(double(14),double(14));
    h_dummy->Fill(double(16),double(16));
    h_dummy->Fill(double(18),double(18));
    h_dummy->Fill(double(20),double(20));

  h_dummy->SetMarkerStyle(20);
  h_dummy->SetMarkerColor(4);
  h_dummy->SetMarkerSize(0.8);
  
  h_dummy->Fit("pol1","QCM");
  Dummy_ChiS = h_dummy->GetFunction("pol1")->GetChisquare();
  Dummy_ndf = h_dummy->GetFunction("pol1")->GetNDF();
  Dummy_Prob = h_dummy->GetFunction("pol1")->GetProb();
  Dummy_red_ChiS = Dummy_ChiS/Dummy_ndf;
  //fit_line_TDC_Gap_Fibers = h_TDC_Gap_Fibers->GetFunction("pol1");
  //fit_line_TDC_Gap_Fibers->SetLineWidth(2);
  //fit_line_TDC_Gap_Fibers->SetLineColor(2);
  //a_fit_TDC_Gap_Fibers=fit_line_TDC_Gap_Fibers->GetParameter(1);      
  ...
  cout << "DUMMY :  " << Dummy_ChiS << "   " << Dummy_ndf << "   " << Dummy_red_ChiS << "   " << Dummy_Prob << endl;
  ////////////////////////////////
  */
  ...
  if(ievt == 2){
    x_Kstop = 10.44;      y_Kstop = -8.38;
    x_SFT1 = 9.95;        y_SFT1 = -28.30;
    angle_Keito = 5.215520;
  }  

  if(ievt == 6){
    x_Kstop = -8.75;     y_Kstop = 10.15;
    x_SFT1 = 28.22;      y_SFT1 = 10.19;
    angle_Keito = 0.5881288;
  }  

  if(ievt == 9){
    x_Kstop = 5.56;       y_Kstop = -18.63;
    x_SFT1 = 24.22;       y_SFT1 = -17.71;
    angle_Keito = 5.801636;
  }  

  if(ievt == 93){
    x_Kstop = 3.812355;       y_Kstop = -10.09610;
    x_SFT1 = 20.57334;        y_SFT1 = 21.83433;
    angle_Keito = 0.9925383;
  }

  if(ievt == 175){
    x_Kstop = 27.58114;      y_Kstop = 36.31294;
    x_SFT1 = 36.55184;        y_SFT1 = 19.48390;
    angle_Keito = 0.061821897;
  }

  if(ievt == 199){
    x_Kstop = 17.26794;      y_Kstop = 19.39980;
    x_SFT1 = -23.92577;        y_SFT1 = 18.09855;
    angle_Keito = 2.526801;
  }

  if(ievt == 22){
    x_Kstop = 7.406819;       y_Kstop = -9.819048;
    x_SFT1 = 23.34566;        y_SFT1 = -18.84092;
    angle_Keito = 5.68993;
  }  

  if(ievt == 27){
    x_Kstop = 8.771022;      y_Kstop = -46.85628;
    x_SFT1 = -0.14261485;      y_SFT1 = -46.82913;
    angle_Keito = 5.622689;
  }

  if(ievt == 21){
    x_Kstop = 1.958588;      y_Kstop = -11.07340;
    x_SFT1 = 28.45046;        y_SFT1 = -9.516887;
    angle_Keito = 6.008253;
  }

  if(ievt == 83){
    x_Kstop = 6.584274;      y_Kstop = 15.12722;
    x_SFT1 = -25.29075;        y_SFT1 = 16.13623;
    angle_Keito = 2.758641;
  }

  if(ievt == 119){
    x_Kstop = -8.545963;      y_Kstop = -16.23992;
    x_SFT1 = 29.23655;        y_SFT1 = 6.724876;
    angle_Keito = 0.1518836;
  }

   if(ievt == 180){
    x_Kstop = -9.938532;      y_Kstop = -3.034012;
    x_SFT1 = 29.99881;        y_SFT1 = 26.738513E-02;
    angle_Keito = 0.3670283;
  }
   ...
   if(ievt == 94){
    x_Kstop = 11.80549;      y_Kstop = -20.21053;
    x_SFT1 = 11.62892;        y_SFT1 = -27.65445;
    angle_Keito = 4.925091;
  }

   if(ievt == 193){
    x_Kstop = -19.10459;      y_Kstop = -29.39423;
    x_SFT1 = -18.68888;        y_SFT1 = -29.65621;
    angle_Keito = 3.727572;
  }
  ...
  h_help_point_Keito->Fit("pol1", "QCM");
  Track_Keito = h_help_point_Keito->GetFunction("pol1");
  Track_Keito->SetLineWidth(2);
  Track_Keito->SetLineColor(6);

  h_help_point_Keito2->Fit("pol1", "QCM");
  Track_Keito2 = h_help_point_Keito2->GetFunction("pol1");
  Track_Keito2->SetLineWidth(2);
  Track_Keito2->SetLineColor(6);
  ...
  cout << "Final Angle (deg.) = " << angle_Keito * 180./PI << "  ( KEITO )" << endl;
  cout << "Chi Square = " << ChiS << endl; 
  cout << "NDF = " << ndf << endl; 
  cout << "Prob. = " << prob << endl; 
  cout << "Reduced Chi Square = " << ChiS/ndf << endl;
  cout << "" << endl;
  cout << "" << endl;
  ...
  if(X_BAR != -10000){
    ...
    if((gap_to_fit_rotate==6 || gap_to_fit_rotate==12 || selected_TOF2==12 || selected_TOF2==6) && Rotate==1){
      ...
      //cout << "DEBUG1 :  " << x_tof1_intersect_1 << "  " << y_tof1_intersect_1 << endl;
      //cout << "DEBUG2 :  " << x_tof1_intersect_2 << "  " << y_tof1_intersect_2 << endl;
      ...
      //cout << "DEBUG1 :  " << x_TDC_Gap_Fibers_intersect1 << "   " << alpha << endl;  
      //cout << "DEBUG2 :  " << y_TDC_Gap_Fibers_intersect1 << "   " << alpha << endl;  
      //cout << "DEBUG3 :  " <<  dist_to_k_stop << endl;
    ...
    //cout << "DEBUG :  " << X_BAR << "   " << Y_BAR << "   " << x_tof1_intersect << "   " << y_tof1_intersect << endl;
    length_in_target = distance(X_BAR,Y_BAR,x_tof1_intersect,y_tof1_intersect); //CORRECT
    //length_in_target = distance(X_BAR,Y_BAR,x_TDC_Gap_Fibers_intersect1,y_TDC_Gap_Fibers_intersect1); //TEST
  ...
  if((gap_to_fit_rotate==12 || gap_to_fit_rotate==6 || selected_TOF2==12 || selected_TOF2==6) && Rotate==1){ //ROTATE_CHANGE
    ...
    //cout << "DEBUG1 :  " << h_TDC_Gap_Fibers->GetEntries() << endl; 
    //cout << "DEBUG2 :  " << h_TDC_Gap_Fibers_copy->GetEntries() << endl; 
    //cout << "DEBUG3 :  " << h_TDC_Gap_Fibers_kaon->GetEntries() << endl; 
    ...
    //if(Switch==1) h_TARGET_LG_Blue->Draw("same");
    A1->Draw();
    A2->Draw();
    h_Circle->Draw("same");
    //h_kaon_copy->Draw("same"); //black
    //h_max_copy->Draw("same"); //purple
    ...
    //tex_Angle_Keito->Draw("same");
    h_int_TDC_TARGET->Draw("same");
    //h_help_point_Keito->Draw("same");
    //h_Keito->Draw("same");
    ...
    k_stop_line->Draw("same");  
      ...
      //cout << "DEBUG COUNT:  " << h_TDC_Gap_Fibers->GetEntries() << endl; 
  ...
  //double sft_z_selected = SFT_Test_CR_Event(Run_Number, ievt, angle_final_guide, gap_to_fit_rotate, true, C2X_centroid, length_in_target);
  ...
  if (display_fits == 1){  
    ...
    TCanvas *cc1;
    cc1 = new TCanvas("Fitting Steps","Fitting Steps",50,50,1050,700);
    cc1->Divide(3,2);
    ...
    h_TOF1->Draw("same");
    h_TOF1_closest->Draw("same");
    CenterLine_GoodLG->Draw("same");
    HorizontalAxis->Draw("same");
    h_int_GoodLG_weighted->Draw("same");
    h_int_GoodLG_SFT->Draw("same");
    tex_Angle_GoodLG->Draw("same");
  }
  

  //cout << "Gap to fit  /  Gap to fit (rotated):  " << gap_to_fit << "   " << gap_to_fit_rotate << endl;
  ...
  //cout << "TEST  : " << TOF1_Z_min << "  " << TOF1_Z_max << endl;

  //cout << "TOF1U  /  TOF1D:  " << TDC_TOF1U[gap_to_fit_rotate-1] << "  " << TDC_TOF1D[gap_to_fit_rotate-1] << endl;
  //cout << "Slope COrrection  /  Offset:  " << Slope_correction_TOF1[gap_to_fit_rotate-1] << "  " << Offset_TOF1[gap_to_fit_rotate-1] << endl;

  cout << "Z_TOF1  =  " << Z_TOF1[gap_to_fit_rotate-1] << " mm" << endl;

  //for(unsigned i=0; i<ZZ.size(); i++){
  //  cout << "ALL Z (DZ<10) :  " << i+1 << "    " << ZZ[i] << endl;
  //}
  ...
  //cout << endl;
  //cout << "TEST:  " << Z_selected.size() << endl;

  //for(unsigned j=0; j<Z_selected.size(); j++){
  //  cout << "TEST2:  " << j+1 << "    " << Z_selected[j] << endl;
  //}
  ...
  //for(unsigned j=0; j<Z_selected.size(); j++){
  //  cout << "TEST3:  " << j+1 << "    " << Z_selected[j] << endl;
  //}
  ...
  cout << endl;
  cout << endl;
  //cout << selected_TOF2 << endl;
  //cout << x_TARGET_intersect << "   " << y_TARGET_intersect << endl;
  //TH2F *h_TARGET_TEST; 
  //TH2F *h_int_TDC_TARGET = new TH2F("h_int_TDC_TARGET", "h_int_TDC_TARGET", 500, -50, 50, 500, -50, 50);
...
//vector<double> SFT_Test_CR_Event2(int Run_Number, int evt, double phi, int gap_to_fit, bool to_print, double C2X_centroid, double length_in_target){
vector<double> SFT_Test_CR_Event2(int Run_Number, int evt, double phi, double C2X_centroid, double length_in_target){
  Int_t adc_high_sft[128];          Int_t ADC_High_SFT[128];        
  Int_t adc_low_sft[128];           //Int_t ADC_Low_SFT[128];   
  Int_t tdc_le_sft[128][16];        //Int_t TDC_LE_SFT[128];         
