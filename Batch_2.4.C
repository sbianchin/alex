...
void Batch_2_4(Int_t Run_Number=5, Int_t ievt_min=2, Int_t ievt_max=2, Int_t Switch_Display=1, Int_t Switch_Zlist=0){ 
  ...
  sprintf(output2,"Run_%d_Zlist.txt",Run_Number);
  ofstream fout2;
  fout2.open(output2);
  ...
  TDC_max_TARGET = kaon_TDC_max;
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(Switch_Display>0){ 
      ...
      cout << setw(9) << setprecision(3) << ChiS << "  ";
      cout << setw(3) << setprecision(0) << ndf << "  ";
      ...
      cout << setw(7) << setprecision(3) << x_TARGET_intersect << "  ";
      cout << setw(7) << setprecision(3) << y_TARGET_intersect << "  ";
    ...
    fout << setw(9) << setprecision(3) << ChiS << "  ";
    fout << setw(3) << setprecision(0) << ndf << "  ";
