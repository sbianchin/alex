...
void Event_Display_5_4(Int_t Run_Number=5, Int_t ievt=0, int walk=0, Int_t enable_cout=0, Int_t display = 0, Int_t graphics = 1, Int_t batch = 0){
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 float x_TDC_Gap_Fibers_intersect1=0.;          float y_TDC_Gap_Fibers_intersect1=0.;
  ...
  ofstream fout;
  fout.open("RUN_3994_diagnose.txt", ios::app);
