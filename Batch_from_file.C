...
//void Batch_4_1(Int_t Run_Number=5, Int_t ievt_min=2, Int_t ievt_max=2, Int_t Switch_Display=0){ 
void Batch_from_file(Int_t Run_Number=5, Int_t Switch_Display=0, Int_t ievt=-1){ 
  ...
  // Switch_Display=0 -> NO printing on screen
  // Switch_Display=1 -> printing on screen
  ...
  if(!flag){
    ...
    cout << "0: NO printinf on screen" << endl;
    cout << "1: Printing on screen " << endl;
    cout << endl;
  }
  ...
  //////////////////////////////////////////////////////////////////////////////////
   ...
   ifstream fdat_read("Keito_run_3994_1.txt", ios::in); 
  ...
  if(Switch_Display==0){
    sprintf(output,"RUN_%d_DATA_from_file.txt",Run_Number);
    //ofstream fout;
    fout.open(output);

    sprintf(output2,"Run_%d_Nan_Events_from_file.txt",Run_Number);
    //ofstream fout2;
    fout2.open(output2);
  }
  ...
  while(fdat_read.good()){
    ...
    ZZ.clear();
    //fChain->GetEntry(ivt);  
    fChain->GetEntry(Read_Run_Number);  
    K_stop_count = 0;
