...
void Event_Display_5_1(Int_t Run_Number=5, Int_t ievt=0, int walk=0, Int_t enable_cout=0, Int_t display = 0){
  ...
  cout << endl << "X coordinate of lepton";
  for (int i = 0; i < vec_xx_lepton.size(); ++i)
    cout << vec_xx_lepton[i] << " ";
  cout << endl << "Y coordinate of lepton";
  for (int i = 0; i < vec_yy_lepton.size(); ++i)
    cout << vec_yy_lepton[i] << " ";
  cout << endl << "X coordinate of lepton rotated";
  for (int i = 0; i < vec_xx_lepton_rotate.size(); ++i)
    cout << vec_xx_lepton_rotate[i] << " ";
  cout << endl << "Y coordinate of lepton rotated";
  for (int i = 0; i < vec_yy_lepton_rotate.size(); ++i)
    cout << vec_yy_lepton_rotate[i] << " ";
