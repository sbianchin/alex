...
void Event_Display_2_2(Int_t Run_Number=5, Int_t ievt=0, Int_t enable_cout=0, Int_t display_fits = 0){ 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for(int i=0; i<12; i++){
      if(i!=0 && i!=11 && gap_counter[i]>0){
        ...
        //cout << "****  " << i << "  " << "IN !" << endl; 
      	...
      	//cout << "GAP_COUNTER :  " << i << "  " << gap_counter[i] << endl;
 ...
 ///////////////////////////////////////////////////////// K STOP CENTROID END
  ...
  cout << "DEBUG:  " << Run_Number << "  " << ievt << "  " << angle_final_guide << "  " << C2X_centroid << "  " << length_in_target << endl;
