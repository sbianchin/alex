...
void Graph() {
   ...
   /*
   vec_xx.push_back(4.65);          vec_yy.push_back(-26.35);
   vec_xx.push_back(4.65);          vec_yy.push_back(-26.35);
   vec_xx.push_back(7.75);          vec_yy.push_back(-23.25);
   vec_xx.push_back(7.75);          vec_yy.push_back(-23.25);
   vec_xx.push_back(7.75);          vec_yy.push_back(-20.15);
   vec_xx.push_back(10.85);         vec_yy.push_back(-20.15);
   vec_xx.push_back(10.85);         vec_yy.push_back(-17.05);
   vec_xx.push_back(13.95);         vec_yy.push_back(-10.85);
   vec_xx.push_back(17.05);         vec_yy.push_back(-10.85);
   vec_xx.push_back(17.05);         vec_yy.push_back(-7.75);
   vec_xx.push_back(17.05);         vec_yy.push_back(-4.65);
...
*/
  ...
  */
   ...
   //TGraph *gr = new TGraph(n,&vec_xx[0],&vec_yy[0]);
   gr->SetLineColor(2);
   gr->SetLineWidth(4);
   gr->SetMarkerColor(4);
