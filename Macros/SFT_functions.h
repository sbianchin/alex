...
double SFT_print(double ADC_High_SFT_corr[128], int has_TDC_SFT_hit[128], int SFT_channel_to_fiber[128],
  ...
  */
  ...
  if(layer_1_p_fibers_d.size() != 0 && layer_2_p_fibers_d.size() != 0 && layer_3_p_fibers_d.size() != 0 && layer_4_p_fibers_d.size() != 0){
    for(std::vector<double>::iterator it_1 = layer_1_p_fibers_d.begin(); it_1 != layer_1_p_fibers_d.end(); it_1++){
      for(std::vector<double>::iterator it_2 = layer_2_p_fibers_d.begin(); it_2 != layer_2_p_fibers_d.end(); it_2++){
        for(std::vector<double>::iterator it_3 = layer_3_p_fibers_d.begin(); it_3 != layer_3_p_fibers_d.end(); it_3++){
          for(std::vector<double>::iterator it_4 = layer_4_p_fibers_d.begin(); it_4 != layer_4_p_fibers_d.end(); it_4++){ // 
...
//std::vector<double> Z_Avg(double ADC_High_SFT_corr[128], int has_TDC_SFT_hit[128], int SFT_channel_to_fiber[128],
// int evt, double phi, bool to_print, double TOF1_pos, bool use_TOF1, double C2X_centroid, double len_in_target){
std::vector<double> Z_Avg(double ADC_High_SFT_corr[128], int has_TDC_SFT_hit[128], int SFT_channel_to_fiber[128],
...
void Ana3(int Run_Number, int evt, double ADC_High_SFT_corr[128], int has_TDC_SFT_hit[128], int SFT_channel_to_fiber[128], double phi, int gap_to_fit_left, int gap_to_fit_right, double C2_Z_top, double C2_Z_bottom){
  ...
  std::vector<int> layer_1_p_fibers;   layer_1_p_fibers.clear();
  std::vector<int> layer_2_p_fibers;   layer_2_p_fibers.clear();
  std::vector<int> layer_3_p_fibers;   layer_3_p_fibers.clear();
  std::vector<int> layer_4_p_fibers;   layer_4_p_fibers.clear();

  std::vector<double> layer_1_adc;   layer_1_adc.clear();
  std::vector<double> layer_2_adc;   layer_2_adc.clear();
  std::vector<double> layer_3_adc;   layer_3_adc.clear();
  std::vector<double> layer_4_adc;   layer_4_adc.clear();

  std::vector<double> layer_1_p_fibers_d;  layer_1_p_fibers_d.clear();
  std::vector<double> layer_2_p_fibers_d;  layer_2_p_fibers_d.clear();
  std::vector<double> layer_3_p_fibers_d;  layer_3_p_fibers_d.clear();
  std::vector<double> layer_4_p_fibers_d;  layer_4_p_fibers_d.clear();
  
  std::vector< std::vector<double> > SFT_Z1_top;  std::vector<double> SFT_Z1_top_col;  
  std::vector< std::vector<double> > SFT_Z2_top;  std::vector<double> SFT_Z2_top_col;  
  std::vector< std::vector<double> > SFT_Z3_top;  std::vector<double> SFT_Z3_top_col;  
  std::vector< std::vector<double> > SFT_Z4_top;  std::vector<double> SFT_Z4_top_col;  
  ...
  std::vector< std::vector<double> > SFT_Z1_bottom;  std::vector<double> SFT_Z1_bottom_col;  
  std::vector< std::vector<double> > SFT_Z2_bottom;  std::vector<double> SFT_Z2_bottom_col;  
  std::vector< std::vector<double> > SFT_Z3_bottom;  std::vector<double> SFT_Z3_bottom_col;  
  std::vector< std::vector<double> > SFT_Z4_bottom;  std::vector<double> SFT_Z4_bottom_col;  
  ...
  std::vector< std::vector<double> > DZ1_top;  std::vector<double> DZ1_top_col;  
  std::vector< std::vector<double> > DZ2_top;  std::vector<double> DZ2_top_col;  
  std::vector< std::vector<double> > DZ3_top;  std::vector<double> DZ3_top_col;  
  std::vector< std::vector<double> > DZ4_top;  std::vector<double> DZ4_top_col;  
  ...
  std::vector< std::vector<double> > DZ1_bottom;  std::vector<double> DZ1_bottom_col;  
  std::vector< std::vector<double> > DZ2_bottom;  std::vector<double> DZ2_bottom_col;  
  std::vector< std::vector<double> > DZ3_bottom;  std::vector<double> DZ3_bottom_col;  
  std::vector< std::vector<double> > DZ4_bottom;  std::vector<double> DZ4_bottom_col;  
  ...
  std::vector<double> DZ1_lowest_top;  std::vector<double> DZ1_lowest_bottom;
  std::vector<double> DZ2_lowest_top;  std::vector<double> DZ2_lowest_bottom;
  std::vector<double> DZ3_lowest_top;  std::vector<double> DZ3_lowest_bottom;
  std::vector<double> DZ4_lowest_top;  std::vector<double> DZ4_lowest_bottom;
  ...
  std::vector<int> n1_lowest_top;      std::vector<int> n1_lowest_bottom;
  std::vector<int> n2_lowest_top;      std::vector<int> n2_lowest_bottom;
  std::vector<int> n3_lowest_top;      std::vector<int> n3_lowest_bottom;
  std::vector<int> n4_lowest_top;      std::vector<int> n4_lowest_bottom;
  ...
  std::vector<int> p1_lowest_top;      std::vector<int> p1_lowest_bottom;
  std::vector<int> p2_lowest_top;      std::vector<int> p2_lowest_bottom;
  std::vector<int> p3_lowest_top;      std::vector<int> p3_lowest_bottom;
  std::vector<int> p4_lowest_top;      std::vector<int> p4_lowest_bottom;
  ...
  std::vector<double> Z1_lowest_top;      std::vector<double> Z1_lowest_bottom;
  std::vector<double> Z2_lowest_top;      std::vector<double> Z2_lowest_bottom;
  std::vector<double> Z3_lowest_top;      std::vector<double> Z3_lowest_bottom;
  std::vector<double> Z4_lowest_top;      std::vector<double> Z4_lowest_bottom;
 ...
 cout << " |===========|==========================================|==========================================| " << endl;
  ...
  std::vector<double> Z1_top;  std::vector<double> Z1_bottom;
  std::vector<double> Z2_top;  std::vector<double> Z2_bottom;
  std::vector<double> Z3_top;  std::vector<double> Z3_bottom;
  std::vector<double> Z4_top;  std::vector<double> Z4_bottom;

  std::vector<double> p1_top;  std::vector<double> p1_bottom;
  std::vector<double> p2_top;  std::vector<double> p2_bottom;
  std::vector<double> p3_top;  std::vector<double> p3_bottom;
  std::vector<double> p4_top;  std::vector<double> p4_bottom;

  std::vector<int> n1_top;  std::vector<int> n1_bottom;
  std::vector<int> n2_top;  std::vector<int> n2_bottom;
  std::vector<int> n3_top;  std::vector<int> n3_bottom;
  std::vector<int> n4_top;  std::vector<int> n4_bottom;

  std::vector<double> D_Z1_top;  std::vector<double> D_Z1_bottom;
  std::vector<double> D_Z2_top;  std::vector<double> D_Z2_bottom;
  std::vector<double> D_Z3_top;  std::vector<double> D_Z3_bottom;
  std::vector<double> D_Z4_top;  std::vector<double> D_Z4_bottom;
  ...
  */
  ...
  std::vector<double> Z_top_final;   std::vector<double> Z_bottom_final;
...
//std::vector<double> Batch_Ana3(int Run_Number, int evt, double ADC_High_SFT_corr[128], int has_TDC_SFT_hit[128], int SFT_channel_to_fiber[128], double phi, int gap_to_fit_left, int gap_to_fit_right, double C2_Z_top, double C2_Z_bottom){
std::vector<double> Batch_Ana3(double ADC_High_SFT_corr[128], int has_TDC_SFT_hit[128], int SFT_channel_to_fiber[128], double phi, int gap_to_fit_left, int gap_to_fit_right, double C2_Z_top, double C2_Z_bottom){
