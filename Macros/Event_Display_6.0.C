...
*/
  ...
  Delta_X = sqrt(pow(TARGET_Errors_X,2) + pow((sin(angle_final_guide)*R_TARGET*Delta_phi_deg),2));
  Delta_Y = sqrt(pow(TARGET_Errors_X,2) + pow((cos(angle_final_guide)*R_TARGET*Delta_phi_deg),2));
...
*/
  ...
  // if () { //insert condition for two-track analysis
...
*/    }
  ...
  if(vec_xx_kaon.size()<5){
    ...
    Two_tracks_Subplot_1(c2_tracks, Run_Number, ievt, gr_lepton_3, gap_to_fit);
    Two_tracks_Subplot_2(c2_tracks, gr_kaon, gr_kaon_bk,
    vec_xx_kaon, kaon_bk, vertical_kaon);
    Two_tracks_Subplot_3(c2_tracks, gr_lepton_3,
      gr_kaon, gr_kaon_bk,
