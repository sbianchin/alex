...
void Event_Display_3_0(Int_t Run_Number=5, Int_t ievt=0, Int_t enable_cout=0, Int_t display = 0){ 
 ...
 /////////////////////////////////////////////////////////////////
  ...
  if(vec_xx_lepton.size() != 0){
    ...
    //cout << "DEBBUG: " << vec_xx_lepton.size() << endl;
  ...
  a_rotate = (-100)/((50*a_fit_TDC_Gap_Fibers - b_fit_TDC_Gap_Fibers)-(-50*a_fit_TDC_Gap_Fibers - b_fit_TDC_Gap_Fibers));
  b_rotate = -50 - a_rotate*(50*a_fit_TDC_Gap_Fibers - b_fit_TDC_Gap_Fibers);
  ...
  if(display != 0){
    ...
    if((gap_to_fit_rotate==6 || gap_to_fit_rotate==12 || selected_TOF2==12 || selected_TOF2==6) && Rotate==1){
      ...
      for(unsigned j=0; j<vec_xx_lepton_rotate.size(); j++){
        vec_yprime_rotate.push_back(a_rotate*vec_xx_lepton_rotate[j] + b_rotate);
        vec_Dy_rotate.push_back(vec_yy_lepton_rotate[j] - (a_rotate*vec_xx_lepton_rotate[j] + b_rotate)); 
      }

      cout << "y = mx + b  with:  m = ";
      cout << setw(7) << setprecision(3) << a_rotate;
      cout << " and b = " << setw(8) << setprecision(3) << b_rotate << endl;
      cout << endl;
