...
void Event_Display_3_2(Int_t Run_Number=5, Int_t ievt=0, int walk=0, Int_t enable_cout=0, Int_t display = 0){ 
 ...
 /////////////////////////////////////////////////////////////////
  ...
  cout << "ALBANE :  " << vec_xx_kaon.size() << endl;
