...
void TOF_Gap_Multiplicity(Int_t Run_Number=5, Int_t time_window=0, Int_t flag=0){ 
...
sprintf(Title_h_count,"Gap Multiplicity -- Run %d", Run_Number); 
sprintf(Name_h_count,"Gap Multiplicity -- Run %d", Run_Number);
...
sprintf(Name_Can,"Gap Multiplicity -- Run %d", Run_Number);
sprintf(Title_Can,"Gap Multiplicity -- Run %d", Run_Number);

TCanvas *c1;
c1 = new TCanvas(Name_Can,Title_Can,800,500); 
