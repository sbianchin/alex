...
//  sprintf(h_target_TDC_title,"Run %d (Event %d) -- ADC #geq %d | %d #leq TDC #leq %d",Run_Number, ievt, par_temp_TARGET[1][0],TDC_min_TARGET,TDC_max_TARGET);
 ...
 /////////////////////////////////////////////////////////////////
  ...
  cout << "" << endl;
      ...
      int C2X_L_ch[56] = {0};
      int C2X_R_ch[56] = {0};
      int C2X_L_ch_temp[56] = {0};
      int C2X_R_ch_temp[56] = {0};
      ...
      for (int q = 224; q < 238; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          C2X_L_temp[q-224] = MWPCADC[q];
          C2X_L_ch_temp[q-224] = q;
      ...
      for (int q = 192; q < 206; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          C2X_L_temp[q-178] = MWPCADC[q];
          C2X_L_ch_temp[q-178] = q;
          //cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for (int q = 160; q < 174; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          C2X_L_temp[q-132] = MWPCADC[q];
          C2X_L_ch_temp[q-132] = q;
          //cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for (int q = 128; q < 142; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          C2X_L_temp[q-86] = MWPCADC[q];
          C2X_L_ch_temp[q-86] = q;
          //cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for (int q = 240; q < 254; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          C2X_R_temp[q-240] = MWPCADC[q];
          C2X_R_ch_temp[q-240] = q;
          //cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for (int q = 208; q < 222; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          C2X_R_temp[q-194] = MWPCADC[q];
          C2X_R_ch_temp[q-194] = q;
          //cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for (int q = 176; q < 190; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          C2X_R_temp[q-148] = MWPCADC[q];
          C2X_R_ch_temp[q-148] = q;
          //cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for (int q = 144; q < 158; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          C2X_R_temp[q-102] = MWPCADC[q];
          C2X_R_ch_temp[q-102] = q;
          //cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for(int i = 0; i < 56; i++){   
        ...
        C2X_L_ch[i] = C2X_L_ch_temp[C2_strip[i]];
        C2X_R_ch[i] = C2X_R_ch_temp[C2_strip[i]];
      } 


      for(int i = 0; i< 56; i++){
        if(Good_Event && C2X_L[i]>0){
          cout << " ADC MWPC Channel " << C2X_L_ch[i]  << " -- C2 X - strip " << i + 1 << "(left)"<< endl;
        }
      }

      for(int i = 0; i< 56; i++){
        if(Good_Event && C2X_R[i]>0){
          cout << " ADC MWPC Channel " << C2X_R_ch[i]  << " -- C2 X - strip " << i + 1 << "(right)"<< endl;
        }
      }
      ...
      for(int q = 96; q < 112; q++){
        if (Good_Event && MWPCADC[q]>0) {
          C2Y_L[15-q+96] = MWPCADC[q];
          }
      }

      for(int q = 112; q < 128; q++){
        if (Good_Event && MWPCADC[q]>0) {
          C2Y_R[15-q+112] = MWPCADC[q];
          }
      }      
      ...
      for (int q = 448; q < 464; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
          C3Y_L[16-q+448] = MWPCADC[q];
        }
      }
      for (int q = 464; q < 480; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
          C3Y_R[16-q+464] = MWPCADC[q];
        }
      }
  ...
  // Calculate and display centroids for C2X-L, C2X-R, C2Y-L, C2Y-R
    ...
    if(gap_to_fit == 6 || gap_to_fit ==12){
      for(unsigned int i = 0; i < 100; i++){
        ...
        for(int j = C2Y_L_cluster_index_arr[i]; j<C2Y_L_cluster_index_arr[i] + C2Y_L_cluster_length_arr[i]; j++){
          if(C2Y_L[j] > 0){
            centroid_sum += C2Y_L[j]*C2_YLoc_12[j];
      ...
      for(unsigned int i = 0; i < 100; i++){
        ...
        for(int j = C2Y_R_cluster_index_arr[i]; j<C2Y_R_cluster_index_arr[i] + C2Y_R_cluster_length_arr[i]; j++){
          if(C2Y_R[j] > 0){
            centroid_sum += C2Y_R[j]*C2_YLoc_6[j];
    ...
    else if(gap_to_fit == 11 || gap_to_fit == 5){
      //same as above, but use rotated coordinates
      // *** C2_YLoc NEEDS TO BE ROTATED TO EACH GAP.
      ...
      for(unsigned int i = 0; i < 100; i++){
        ...
        for(int j = C2Y_L_cluster_index_arr[i]; j<C2Y_L_cluster_index_arr[i] + C2Y_L_cluster_length_arr[i]; j++){
          if(C2Y_L[j] > 0){
            centroid_sum += C2Y_L[j]*C2_YLoc_11[j];
            centroid_den += C2Y_L[j];
          }
        }
      ...
      for(unsigned int i = 0; i < 100; i++){
        ...
        for(int j = C2Y_R_cluster_index_arr[i]; j<C2Y_R_cluster_index_arr[i] + C2Y_R_cluster_length_arr[i]; j++){
          if(C2Y_R[j] > 0){
            centroid_sum += C2Y_R[j]*C2_YLoc_5[j];
            centroid_den += C2Y_R[j];
          }
        }
    ...
    else if(gap_to_fit == 7 || gap_to_fit == 1){
      for(unsigned int i = 0; i < 100; i++){
        centroid_sum = 0.0;
        centroid_den = 0.0;
        ...
        for(int j = C2Y_L_cluster_index_arr[i]; j<C2Y_L_cluster_index_arr[i] + C2Y_L_cluster_length_arr[i]; j++){
          if(C2Y_L[j] > 0){
            centroid_sum += C2Y_L[j]*C2_YLoc_7[j];
            centroid_den += C2Y_L[j];
          }
        }
      ...
      for(unsigned int i = 0; i < 100; i++){
        ...
        for(int j = C2Y_R_cluster_index_arr[i]; j<C2Y_R_cluster_index_arr[i] + C2Y_R_cluster_length_arr[i]; j++){
          if(C2Y_R[j] > 0){
            centroid_sum += C2Y_R[j]*C2_YLoc_1[j];
            centroid_den += C2Y_R[j];
          }
        }
    ...
    if(MWPC_switch==1){
      ...
      TH2F *C2_L_hist = new TH2F("", "", 500, -280,280,500, -1,16);
      TH2F *C3_L_hist = new TH2F("", "", 500, -1,64,500, -1,16); 
      TH2F *C4_L_hist = new TH2F("", "", 500, -1,72,500, -1,16);

      TH2F *C2_R_hist = new TH2F("", "", 500, -280,280,500, -1,16);
      TH2F *C3_R_hist = new TH2F("", "", 500, -1,64,500, -1,16); 
      TH2F *C4_R_hist = new TH2F("", "", 500, -1,72,500, -1,16);      
      ...
      C2_L_hist->SetNdivisions(16,"Y");
      C3_L_hist->SetNdivisions(16,"Y");
      C4_L_hist->SetNdivisions(16,"Y");
      ...
      C2_R_hist->SetNdivisions(16,"Y");
      C3_R_hist->SetNdivisions(16,"Y");
      C4_R_hist->SetNdivisions(16,"Y"); 


      TGaxis *C2_top = new TGaxis(-280,16,280,16,"pol1",510,"+U");
      TGaxis *C2_right = new TGaxis(280,-1,280,16,"pol1",510,"-U");
      TGaxis *C3_top = new TGaxis(-1,16,64,16,"pol1",510,"+U");
      TGaxis *C3_right = new TGaxis(64,-1,64,16,"pol1",510,"-U");
      TGaxis *C4_top = new TGaxis(-1,16,72,16,"pol1",510,"+U");
      TGaxis *C4_right = new TGaxis(72,-1,72,16,"pol1",510,"-U");   
      ...
      char c4_R_title[200];      
        ...
        sprintf(c2_L_title,"C2 Left   |   Run Number %d   |    Event %d   ", Run_Number, ievt);
        sprintf(c3_L_title,"C3 Left   |   Run Number %d   |    Event %d   ", Run_Number, ievt);
        sprintf(c4_L_title,"C4 Left   |   Run Number %d   |    Event %d   ", Run_Number, ievt);

        sprintf(c2_R_title,"C2 Right   |   Run Number %d   |    Event %d   ", Run_Number, ievt);
        sprintf(c3_R_title,"C3 Right   |   Run Number %d   |    Event %d   ", Run_Number, ievt);
        sprintf(c4_R_title,"C4 Right   |   Run Number %d   |    Event %d   ", Run_Number, ievt);
      


      tex_Title_MWPC_C2_L = new TLatex(-280,16.5,c2_L_title);
      tex_Title_MWPC_C3_L = new TLatex(0,16.5,c3_L_title);
      tex_Title_MWPC_C4_L = new TLatex(0,16.5,c4_L_title);

      tex_Title_MWPC_C2_L->SetTextSize(0.07645875);
      tex_Title_MWPC_C2_L->SetLineWidth(2);
      tex_Title_MWPC_C2_L->Draw();

      tex_Title_MWPC_C3_L->SetTextSize(0.07645875);
      tex_Title_MWPC_C3_L->SetLineWidth(2);
      tex_Title_MWPC_C3_L->Draw();

      tex_Title_MWPC_C4_L->SetTextSize(0.07645875);
      tex_Title_MWPC_C4_L->SetLineWidth(2);
      tex_Title_MWPC_C4_L->Draw();



      tex_Title_MWPC_C2_R = new TLatex(-280,16.5,c2_R_title);
      tex_Title_MWPC_C3_R = new TLatex(0,16.5,c3_R_title);
      tex_Title_MWPC_C4_R = new TLatex(0,16.5,c4_R_title);

      tex_Title_MWPC_C2_R->SetTextSize(0.07645875);
      tex_Title_MWPC_C2_R->SetLineWidth(2);
      tex_Title_MWPC_C2_R->Draw();

      tex_Title_MWPC_C3_R->SetTextSize(0.07645875);
      tex_Title_MWPC_C3_R->SetLineWidth(2);
      tex_Title_MWPC_C3_R->Draw();

      tex_Title_MWPC_C4_R->SetTextSize(0.07645875);
      ...
      for(int i = 0; i < C2X_L_count; i++){
        C2X_L_line[i] = new TLine(C2_ZLoc[*(C2X_L_wire_numbers.begin() + i)], -1, C2_ZLoc[*(C2X_L_wire_numbers.begin() + i)], 16);
      ...
      for(int i = 0; i < C2X_R_count; i++){
        C2X_R_line[i] = new TLine(C2_ZLoc[*(C2X_R_wire_numbers.begin() + i)], -1, C2_ZLoc[*(C2X_R_wire_numbers.begin() + i)], 16);
      ...
      for(int i = 0; i < C2Y_L_count; i++){
        C2Y_L_line[i] = new TLine(-280,*(C2Y_L_wire_numbers.begin() + i), 280, *(C2Y_L_wire_numbers.begin() + i));
      ...
      for(int i = 0; i < C2Y_R_count; i++){
        C2Y_R_line[i] = new TLine(-280,*(C2Y_R_wire_numbers.begin() + i), 280, *(C2Y_R_wire_numbers.begin() + i));
      ...
      for(int i = 0; i < C3X_L_count; i++){
        C3X_L_line[i] = new TLine(*(C3X_L_wire_numbers.begin() + i), -1, *(C3X_L_wire_numbers.begin() + i), 16);
      ...
      for(int i = 0; i < C3X_R_count; i++){
        C3X_R_line[i] = new TLine(*(C3X_R_wire_numbers.begin() + i), -1, *(C3X_R_wire_numbers.begin() + i), 16);
      ...
      for(int i = 0; i < C3Y_L_count; i++){
        C3Y_L_line[i] = new TLine(-1,*(C3Y_L_wire_numbers.begin() + i), 64, *(C3Y_L_wire_numbers.begin() + i));
      ...
      for(int i = 0; i < C3Y_R_count; i++){
        C3Y_R_line[i] = new TLine(-1,*(C3Y_R_wire_numbers.begin() + i), 64, *(C3Y_R_wire_numbers.begin() + i));
      ...
      for(int i = 0; i < C4X_L_count; i++){
        C4X_L_line[i] = new TLine(*(C4X_L_wire_numbers.begin() + i), -1, *(C4X_L_wire_numbers.begin() + i), 16);
      ...
      for(int i = 0; i < C4X_R_count; i++){
        C4X_R_line[i] = new TLine(*(C4X_R_wire_numbers.begin() + i), -1, *(C4X_R_wire_numbers.begin() + i), 16);
      ...
      for(int i = 0; i < C4Y_L_count; i++){
        C4Y_L_line[i] = new TLine(-1,*(C4Y_L_wire_numbers.begin() + i), 72, *(C4Y_L_wire_numbers.begin() + i));
      ...
      for(int i = 0; i < C4Y_R_count; i++){
        C4Y_R_line[i] = new TLine(-1,*(C4Y_R_wire_numbers.begin() + i), 72, *(C4Y_R_wire_numbers.begin() + i));
...
///////////////////////////////////////////////////////// K STOP CENTROID END
  ...
  // ROTATE_CHANGE
  if((gap_to_fit == 6 || gap_to_fit ==12) && Rotate==1){  
    for(int g=0; g<3; g++){
  ...
  // Add weight to center point of selected TOF1 (gap_to_fit)
  for(int i = 0; i<3; i++){
  ...
  if((gap_to_fit_rotate == 6 || gap_to_fit_rotate ==12) && Rotate==1){
    ...
    // MWPC track through C2 chambers.
    // find slope for each line, then draw the line with the closest slope to the track angle.
    // 
    // a_fit_TDC_Gap_Fibers // track slope
    // C2X_L_centroids[max_length] // entries should be greater than -10000 
    // C2X_R_centroids[max_length]
    // C2Y_L_centroids[max_length]
    // C2Y_R_centroids[max_length]  

    // switch for tof1 = 12/6
    // switch for tof1 = 11/5

    // If tof1 = 11/5, multiply centroid coordinates by rotation matrix
    //  |sqrt(3)/2         -1/2|
    //  |                      |
    //  |1/2          sqrt(3)/2|
    //
    ...
    // Defined above
    // double C2X_L_centroids_rotate[max_length] // entries should be greater than -10000 
    // double C2X_R_centroids_rotate[max_length]
    // double C2Y_L_centroids_rotate[max_length]
    // double C2Y_R_centroids_rotate[max_length]  

    // if(tof1_rotation_switch == 1){
    //   //rotate coordinates:
    //   for(int i = 0; i < max_length; i++){
    //     if(C2X_L_centroids[i] < 5000)
    //       break;

    //     C2X_L_centroids_rotate[i] = (sqrt(3)/2)*C2X_L_centroids[i] -(1/2)*629.4;
    //   }

    //   for(int i = 0; i < max_length; i++){
    //     if(C2X_R_centroids[i] < 5000)
    //       break;

    //     C2X_R_centroids_rotate[i] = (sqrt(3)/2)*C2R_L_centroids[i] +(1/2)*629.4;
    //   }
    ...
    double c2_centroid_slope_edge1 = 0.0;
    double c2_centroid_slope_edge2 = 0.0;
    double c2_centroid_y_int_edge1 = 0;
    double c2_centroid_y_int_edge2 = 0;
    ...
    double x1_rotated_selected_edge1 = 0;
    double y1_rotated_selected_edge1 = 0;
    double x2_rotated_selected_edge1 = 0;
    double y2_rotated_selected_edge1 = 0;

    double x1_rotated_selected_edge2 = 0;
    double y1_rotated_selected_edge2 = 0;
    double x2_rotated_selected_edge2 = 0;
    double y2_rotated_selected_edge2 = 0;        
    ...
    for(int i = 0; i < max_length; i++){
      ...
      for(int j = 0; j < max_length; j++){
        ...
        if(gap_to_fit_rotate == 6 || gap_to_fit_rotate == 12){ // 
        ...
        else if(gap_to_fit_rotate == 5 || gap_to_fit_rotate == 11){  // tof1 = 11/5
          x1_rotated = (sqrt(3.0)/2.0)*C2Y_L_centroids[i] - (1.0/2.0)*629.4;
          x2_rotated = (sqrt(3.0)/2.0)*C2Y_R_centroids[j] + (1.0/2.0)*629.4;
          y1_rotated = (1.0/2.0)*C2Y_L_centroids[i] + (sqrt(3.0)/2.0)*629.4;
          y2_rotated = (1.0/2.0)*C2Y_R_centroids[j] - (sqrt(3.0)/2.0)*629.4;
          ...
          if(fabs(c2_centroid_slope - target_slope) < min_slope_difference){
            ...
            x1_rotated_selected_edge1 = (sqrt(3.0)/2.0)*(C2Y_L_centroids[i]-4.5) - (1.0/2.0)*629.4;
            x2_rotated_selected_edge1 = (sqrt(3.0)/2.0)*(C2Y_R_centroids[j]-4.5) + (1.0/2.0)*629.4;
            y1_rotated_selected_edge1 = (1.0/2.0)*(C2Y_L_centroids[i]-4.5) + (sqrt(3.0)/2.0)*629.4;
            y2_rotated_selected_edge1 = (1.0/2.0)*(C2Y_R_centroids[j]-4.5) - (sqrt(3.0)/2.0)*629.4;

            x1_rotated_selected_edge2 = (sqrt(3.0)/2.0)*(C2Y_L_centroids[i]+4.5) - (1.0/2.0)*629.4;
            x2_rotated_selected_edge2 = (sqrt(3.0)/2.0)*(C2Y_R_centroids[j]+4.5) + (1.0/2.0)*629.4;
            y1_rotated_selected_edge2 = (1.0/2.0)*(C2Y_L_centroids[i]+4.5) + (sqrt(3.0)/2.0)*629.4;
            y2_rotated_selected_edge2 = (1.0/2.0)*(C2Y_R_centroids[j]+4.5) - (sqrt(3.0)/2.0)*629.4; 
    ...
    if(min_slope_difference != 10000000.0){
      if(gap_to_fit_rotate == 6 || gap_to_fit_rotate ==12){
        c2_centroid_slope = points_to_slope(C2Y_L_centroids[selected_C2L_index], 629.4, C2Y_R_centroids[selected_C2R_index], -629.4);
        c2_centroid_int = points_to_y_int(C2Y_L_centroids[selected_C2L_index], 629.4, C2Y_R_centroids[selected_C2R_index], -629.4);

        C2_line = new TLine(0.0, c2_centroid_int, 10.0, c2_centroid_int + 10*c2_centroid_slope);
        C2_line_edge1 = new TLine(0.0, c2_centroid_int, 10.0, c2_centroid_int + 10*c2_centroid_slope);
        C2_line_edge2 = new TLine(0.0, c2_centroid_int, 10.0, c2_centroid_int + 10*c2_centroid_slope);

      }
      else if(gap_to_fit_rotate == 5 || gap_to_fit_rotate ==11){
        ...
        c2_centroid_slope_edge1 = points_to_slope(x1_rotated_selected_edge1, y1_rotated_selected_edge1, x2_rotated_selected_edge1, y2_rotated_selected_edge1);
        c2_centroid_y_int_edge1 = points_to_y_int(x1_rotated_selected_edge1, y1_rotated_selected_edge1, x2_rotated_selected_edge1, y2_rotated_selected_edge1);

        c2_centroid_slope_edge2 = points_to_slope(x1_rotated_selected_edge2, y1_rotated_selected_edge2, x2_rotated_selected_edge2, y2_rotated_selected_edge2);
        c2_centroid_y_int_edge2 = points_to_y_int(x1_rotated_selected_edge2, y1_rotated_selected_edge2, x2_rotated_selected_edge2, y2_rotated_selected_edge2);

        C2_line = new TLine(-50, c2_centroid_slope*(-50.0) + c2_centroid_int, 50, c2_centroid_slope*(50.0)+ c2_centroid_int);
        C2_line_edge1 = new TLine(-50, c2_centroid_slope_edge1*(-50.0) + c2_centroid_y_int_edge1, 50, c2_centroid_slope_edge1*(50.0)+ c2_centroid_y_int_edge1);
        C2_line_edge2 = new TLine(-50, c2_centroid_slope_edge2*(-50.0) + c2_centroid_y_int_edge2, 50, c2_centroid_slope_edge2*(50.0)+ c2_centroid_y_int_edge2);
      }

        C2_line->SetLineWidth(2);
        C2_line->SetLineColor(kGreen);

        C2_line_edge1->SetLineWidth(1.5);
        C2_line_edge1->SetLineColor(kGreen);

        C2_line_edge2->SetLineWidth(1.5);
        C2_line_edge2->SetLineColor(kGreen);                

    }
    else{
      C2_line = new TLine(0.0, 0.0, 0.0, 50.0);
      C2_line_edge1 = new TLine(0.0, 0.0, 0.0, 50.0);
      C2_line_edge2 = new TLine(0.0, 0.0, 0.0, 50.0);

      C2_line->SetLineWidth(2);
      C2_line->SetLineColor(kGreen);

      C2_line_edge1->SetLineWidth(1);
      C2_line_edge1->SetLineColor(kGreen);

      C2_line_edge2->SetLineWidth(1);
      C2_line_edge2->SetLineColor(kGreen);        
    }
    ...
    cout << "" << endl;
    cout << "" << endl;
    cout << "Final Angle (deg.) = " << angle_final_guide << "  ( GUIDE )" << endl;
    cout << "" << endl;
    cout << "" << endl;
  ...
  if((gap_to_fit_rotate==6 || gap_to_fit_rotate==12) && Rotate==1){ //ROTATE_CHANGE
      ...
      C2_line->Draw("same");
      C2_line_edge1->Draw("same");
      C2_line_edge2->Draw("same");
  ...
  double C2_gap_11_edge_1_x = (sqrt(3.0)/2.0)*(-80.) - (1.0/2.0)*629.4;
  double C2_gap_11_edge_2_x = (sqrt(3.0)/2.0)*(80.) - (1.0/2.0)*629.4;
  double C2_gap_5_edge_1_x = (sqrt(3.0)/2.0)*(-80.) + (1.0/2.0)*629.4;
  double C2_gap_5_edge_2_x = (sqrt(3.0)/2.0)*(80.) + (1.0/2.0)*629.4;

  double C2_gap_11_edge_1_y = (1.0/2.0)*(-80.) + (sqrt(3.0)/2.0)*629.4;
  double C2_gap_11_edge_2_y = (1.0/2.0)*(+80.) + (sqrt(3.0)/2.0)*629.4;
  double C2_gap_5_edge_1_y = (1.0/2.0)*(-80.) - (sqrt(3.0)/2.0)*629.4;
  double C2_gap_5_edge_2_y = (1.0/2.0)*(+80.) - (sqrt(3.0)/2.0)*629.4;

  double C2_gap_12_edge_1_x = -80.;
  double C2_gap_12_edge_2_x = 80.;
  double C2_gap_6_edge_1_x = -80.;
  double C2_gap_6_edge_2_x = 80.;

  double C2_gap_12_edge_1_y = 629.4;
  double C2_gap_12_edge_2_y = 629.4;
  double C2_gap_6_edge_1_y = -629.4;
  double C2_gap_6_edge_2_y = -629.4;

  double C2_gap_1_edge_1_x = (sqrt(3.0)/2.0)*(-80.) + (1.0/2.0)*629.4;
  double C2_gap_1_edge_2_x = (sqrt(3.0)/2.0)*(80.) + (1.0/2.0)*629.4;
  double C2_gap_7_edge_1_x = (sqrt(3.0)/2.0)*(-80.) - (1.0/2.0)*629.4;
  double C2_gap_7_edge_2_x = (sqrt(3.0)/2.0)*(80.) - (1.0/2.0)*629.4;

  double C2_gap_1_edge_1_y = (-1.0/2.0)*(-80.) + (sqrt(3.0)/2.0)*629.4;
  double C2_gap_1_edge_2_y = (-1.0/2.0)*(+80.) + (sqrt(3.0)/2.0)*629.4;
  double C2_gap_7_edge_1_y = (-1.0/2.0)*(-80.) - (sqrt(3.0)/2.0)*629.4;
  double C2_gap_7_edge_2_y = (-1.0/2.0)*(+80.) - (sqrt(3.0)/2.0)*629.4;


  TLine *C2_line_display;
  TLine *C2_line_edge1_display;
  TLine *C2_line_edge2_display;
  ...
  for(int i = 0; i < c2xl_num_lines; i++){
    for(int j = 0; j < c2xr_num_lines; j++){
      ...
      if(C2_intersect_top(points_to_slope(C2X_L_centroids[i],629.4,C2X_R_centroids[j],-629.4),points_to_y_int(C2X_L_centroids[i],629.4,C2X_R_centroids[j],-629.4),R_SFT_L1) > -135 && 
         C2_intersect_top(points_to_slope(C2X_L_centroids[i],629.4,C2X_R_centroids[j],-629.4),points_to_y_int(C2X_L_centroids[i],629.4,C2X_R_centroids[j],-629.4),R_SFT_L1) < 135)
           cout << "C2 Z intersect = " << 
           C2_intersect_top(points_to_slope(C2X_L_centroids[i],629.4,C2X_R_centroids[j],-629.4),points_to_y_int(C2X_L_centroids[i],629.4,C2X_R_centroids[j],-629.4),R_SFT_L1) << endl;
      
      if(C2_intersect_bottom(points_to_slope(C2X_L_centroids[i],629.4,C2X_R_centroids[j],-629.4),points_to_y_int(C2X_L_centroids[i],629.4,C2X_R_centroids[j],-629.4),R_SFT_L1) > -135 && 
         C2_intersect_bottom(points_to_slope(C2X_L_centroids[i],629.4,C2X_R_centroids[j],-629.4),points_to_y_int(C2X_L_centroids[i],629.4,C2X_R_centroids[j],-629.4),R_SFT_L1) < 135)      
            cout << "C2 Z intersect = " << 
            C2_intersect_bottom(points_to_slope(C2X_L_centroids[i],629.4,C2X_R_centroids[j],-629.4),points_to_y_int(C2X_L_centroids[i],629.4,C2X_R_centroids[j],-629.4),R_SFT_L1) << endl;
  ...
  SFT_Test_CR_Event(Run_Number,ievt,angle_final_guide);
