...
//void Batch_Read(Int_t Run_Number=5, Int_t ievt_min=2, Int_t ievt_max=2, Int_t Switch_Display=0, Int_t Switch_Zlist=0){ 
//void Batch_Read(Int_t Run_Number=5, Int_t ievt_min=2, Int_t ievt_max=2, Int_t Switch_Display=0, Int_t Switch_Zlist=0){ 
void Batch_Read(Int_t Run_Number=5, Int_t Switch_Display=0, Int_t Switch_Zlist=0){ 
  ...
  int ivt;
  int counter = 0;
  vector<int> vec_bad_events;
  vec_bad_events.clear();
  ...
  char ascii[100];
  sprintf(ascii,"Keito_elist_3994.txt");

  sprintf(output,"RUN_%d_E_DATA.txt",Run_Number);
  ofstream fout;
  fout.open(output);

  sprintf(output2,"Run_%d_E_BadEvents.txt",Run_Number);
  ofstream fout2;
  fout2.open(output2);
  ...
  ifstream file_to_open("Keito_elist_3994.txt", ios::in);
  ...
  if(Switch_Display==0 || Switch_Display==1){
    cout << endl;
    cout << "//////////   INPUTS   //////////" << endl;
    cout << "ROOT File:  " << Name_finput << endl;
    if(!NoFile) cout << "Time Walk Parameter File:  " << ParsTarg1 << endl;
    if(NoFile) cout << "Time Walk Parameter File:  " << "NOT FOUND !" << endl;
    cout << "ASCII File:  " << ascii << endl;
    cout << endl;
    cout << endl;
    cout << "//////////   OUTPUTS   //////////" << endl;
    cout << "Analyzed Events:  " << output << "  " << endl;
    cout << "Bad Events:  " << output2 << "  " << endl;
    cout << endl;
    cout << endl;
    cout << "//////////   PARAMETERS   //////////" << endl;
    cout << "ADC_HG(kaon) >= " << HG_KAON << endl;
    cout << "ADC_LG(kaon) >= " << LG_KAON << endl;
    cout << "max_dist = " << max_dist << endl;
    cout << "Kstop Average Offset min = " << TDC_Kstop_Avg_Offset_min << endl;
    cout << "Kstop Average Offset max = " << TDC_Kstop_Avg_Offset_max << endl;
    cout << endl;
    cout << endl;
  } 
  ...
  while(file_to_open.good()){
    file_to_open >> Run_Number >> ivt;
    if(file_to_open.eof()) break;
  ...
  for(int i=0; i<12; i++) gap_counter[i] = 0;
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(vec_xx_lepton.size() == 0 ) vec_bad_events.push_back(ivt);
    ...
    if(Switch_Display==1 || Switch_Display==2){
      ...
      fout << setw(7) << setprecision(3) << x_TARGET_intersect << "  ";
      fout << setw(7) << setprecision(3) << y_TARGET_intersect << "  ";
  ...
  for(unsigned i=0; i<vec_bad_events.size(); i++){
    fout2 << fixed;
    fout2 << setw(4) << Run_Number << "  ";
    fout2 << setw(7) << vec_bad_events[i] << "  ";
    fout2 << endl;
  }
