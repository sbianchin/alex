...
Lepton FindKaons(vector<double> vec_xx_lepton, vector<double> vec_yy_lepton, vector <double> vec_xx_lepton_rotate, vector <double> vec_yy_lepton_rotate, vector <double> vec_xx_kaon, vector <double> vec_yy_kaon){
          ...
          if((minDiff > Tstep) && (minDiff < 70.0)) {
            ...
            cout << endl;
             // cout<<"Target dE dt "<<ii<<" "<<Ehit[ii]<<" "<<Thit[ii]<<" "<<Xhit[ii]<<" "<<Yhit[ii]<<endl;
              ...
              vec_xx_lepton_rotate.push_back(Xloc[TARGET_Rotated_index[ii]]);
              vec_yy_lepton_rotate.push_back(Yloc[TARGET_Rotated_index[ii]]);
...
Double_t        SFTpz;
  ...
  AGAIN:
    ...
    Subplot_5(vec_xx_lepton, vec_yy_lepton, vec_xx_lepton_rotate,
      vec_yy_lepton_rotate, vec_xx_kaon, vec_yy_kaon);
      */
    Subplot_4(gr3_Leptons_rotate, gr3_Leptons,
      a_fit_TDC_Gap_Fibers, b_fit_TDC_Gap_Fibers,
      Xloc_TOF, Yloc_TOF, Xloc_TOF_flipped, Yloc_TOF_flipped, irt);
    Subplot_5(gr_kaon, vec_xx_kaon, a_fit_TDC_Gap_Fibers, b_fit_TDC_Gap_Fibers, irt);
    Subplot_6(gr3_Leptons_rotate, gr3_Leptons, gr_kaon,
      vec_xx_kaon, a_gr_Leptons, b_gr_Leptons,
    a_fit_TDC_Gap_Fibers, b_fit_TDC_Gap_Fibers, a_fit_kaon,
    b_fit_kaon, vec_test, irt);
    //Draw Plot 2
