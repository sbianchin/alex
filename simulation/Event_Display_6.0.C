// modify lines 3037, 3038 for dX,dY calculation to use Delta_phi in RADIANS -- MH  Oct 14/17
// modify lines 1168, 3139, 3167, 5224 to use kaon_cluster_size parameter
...
*/
  ...
  // use Delta_phi in RADIANS -- MH Oct 14/17
