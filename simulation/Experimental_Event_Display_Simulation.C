...
void Event_Display_5_1(Int_t Run_Number=5, Int_t ievt=0, int walk=0, Int_t enable_cout=0, Int_t display = 0){
  ...
  TF1 *gr_test_lepton_fit;             TF1 *gr_test_kaon_fit;
  ...
  if(vec_xx_lepton.size()>0){
    ...
    gr_test_lepton_fit->SetLineColor(3);
  ...
  */
  ...
  if(vec_xx_lepton.size() != 0){ //check if vec_xx_lepton is empty
  ...
  {
    cout << "Empty Fit Lepton" << endl;
    //return;
  }

  if(vec_xx_kaon.size() == 0){ //check if vec_xx_kaon is empty
    cout << "Empty Fit Kaon" << endl;
  ...
  */
  ...
  //intersection between blue and red lines
  cout << setw(6) << setprecision(3) << vec_test[0] << "  ";
  cout << setw(6) << setprecision(3) << vec_test[1] << "  ";
  //cout << setw(8) << setprecision(1) << 550 - (0.91*TDC_average - 0.625*tdc_Ck) << "  ";

  cout << endl;

  ofstream fout;
  fout.open("RUN_DATA_Event_Display.txt", ios::app);
  fout << fixed;
  ...
  //intersection between blue and red line
  fout << setw(6) << setprecision(3) << vec_test[0] << "  ";
  fout << setw(6) << setprecision(3) << vec_test[1] << "  ";
  fout << setw(6) << setprecision(3) << -1/a_fit_TDC_Gap_Fibers << "  ";
  fout << setw(6) << setprecision(3) << -b_fit_TDC_Gap_Fibers/a_fit_TDC_Gap_Fibers << "  ";
  fout << setw(6) << setprecision(3) << a_gr_Leptons << "  ";
  fout << setw(6) << setprecision(3) << b_gr_Leptons << "  ";
