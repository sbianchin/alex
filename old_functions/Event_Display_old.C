...
void Event_Display(Int_t Run_Number=5, Int_t ievt=0, Int_t enable_cout=0, Int_t display_fits = 0)
{ 
 ...
 /////////////////////////////////////////////////////////////////
  ...
  cout << "" << endl;
      ...
      for (int q = 224; q < 238; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          ...
          C2X_L[q-224] = MWPCADC[c2_x_left[q]];
      ...
      for (int q = 192; q < 206; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          ...
          C2X_L[q-178] = MWPCADC[c2_x_left[q]];
          cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for (int q = 160; q < 174; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          ...
          C2X_L[q-132] = MWPCADC[c2_x_left[q]];
          cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for (int q = 128; q < 142; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          ...
          C2X_L[q-86] = MWPCADC[c2_x_left[q]];
          cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for (int q = 240; q < 254; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          ...
          C2X_R[q-240] = MWPCADC[c2_x_right[q]];
          cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for (int q = 208; q < 222; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          ...
          C2X_R[q-194] = MWPCADC[c2_x_right[q]];
          cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for (int q = 176; q < 190; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          ...
          C2X_R[q-148] = MWPCADC[c2_x_right[q]];
          cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for (int q = 144; q < 158; q++) {
        if (Good_Event && MWPCADC[q]>0) {
          ...
          C2X_R[q-102] = MWPCADC[c2_x_right[q]];
          cout << " ADC MWPC Channel " << q << " -- " << par_temp2[q] << ": " << MWPCADC[q] << endl;
        }
      }
      ...
      for(int i = 0; i < 56; i++){   
        C2X_L_ch[i] = C2X_L_temp[C2_strip[i]];

        //C2X_L[i] = MWPCADC[c2_x_left[i]];

        //cout << "//////////   " << i+1 << "  " << c2_x_left[i] << "   " << C2X_L[i] << "   " << MWPCADC[c2_x_left[i]] << endl;

        C2X_R_ch[i] = C2X_R_temp[C2_strip[i]];
      } 

      for(int i = 0; i < 56; i++){
        C2X_R[i] = C2X_R_ch[55-i];
        C2X_L[i] = C2X_L_ch[55-i];
      }


      // for(int i = 0; i< 56; i++){
      //   if(Good_Event && C2X_L[i]>0){
      //     cout << " ADC MWPC Channel " << C2X_L_ch[i]  << " -- C2_X_" << i+1 << "_Left: " << C2X_L[i] << endl;
      //   }
      // }

      // for(int i = 0; i< 56; i++){
      //   if(Good_Event && C2X_R[i]>0){
      //     cout << " ADC MWPC Channel " << C2X_R_ch[i]  << " -- C2_X_" << i+1 << "_Right: " << C2X_R[i] << endl;
      //   }
      // }
  ...
  if(selected_TOF2 > 6){  // LEFT
    ...
    if(MWPC_switch==1){
      ...
      TH2F *C2_hist = new TH2F("", "", 500, -280,280,500, -1,16);
      TH2F *C3_hist = new TH2F("", "", 500, -1,64,500, -1,16); 
      TH2F *C4_hist = new TH2F("", "", 500, -1,72,500, -1,16);
      ...
      C2_hist->SetNdivisions(16,"Y");
      C3_hist->SetNdivisions(16,"Y");
      C4_hist->SetNdivisions(16,"Y");
      ...
      double C2_palette_loc = -315;
      double C2_tex_palette_loc = -305;
      // C2 legend
      ...
      tex_palette_MWPC_C2[9] = new TLatex(C2_tex_palette_loc,7,ADC_palette_string_MWPC[9]);       tex_palette_MWPC_C2[9]->SetTextSize(text_size_MWPC);



      palette_MWPC[0] = new TMarker(-5,16,21);     palette_MWPC[0]->SetMarkerColor(kOrange+10);    palette_MWPC[0]->SetMarkerSize(flag_size_palette_MWPC);
      palette_MWPC[1] = new TMarker(-5,15,21);     palette_MWPC[1]->SetMarkerColor(kOrange+7);     palette_MWPC[1]->SetMarkerSize(flag_size_palette_MWPC);
      palette_MWPC[2] = new TMarker(-5,14,21);     palette_MWPC[2]->SetMarkerColor(kOrange+1);     palette_MWPC[2]->SetMarkerSize(flag_size_palette_MWPC);
      palette_MWPC[3] = new TMarker(-5,13,21);     palette_MWPC[3]->SetMarkerColor(kOrange-4);     palette_MWPC[3]->SetMarkerSize(flag_size_palette_MWPC);
      palette_MWPC[4] = new TMarker(-5,12,21);     palette_MWPC[4]->SetMarkerColor(kYellow-9);     palette_MWPC[4]->SetMarkerSize(flag_size_palette_MWPC);
      palette_MWPC[5] = new TMarker(-5,11,21);     palette_MWPC[5]->SetMarkerColor(kYellow-7);     palette_MWPC[5]->SetMarkerSize(flag_size_palette_MWPC);
      palette_MWPC[6] = new TMarker(-5,10,21);     palette_MWPC[6]->SetMarkerColor(kYellow-0);     palette_MWPC[6]->SetMarkerSize(flag_size_palette_MWPC);
      palette_MWPC[7] = new TMarker(-5,9,21);      palette_MWPC[7]->SetMarkerColor(kSpring-4);     palette_MWPC[7]->SetMarkerSize(flag_size_palette_MWPC);
      palette_MWPC[8] = new TMarker(-5,8,21);      palette_MWPC[8]->SetMarkerColor(kSpring-2);     palette_MWPC[8]->SetMarkerSize(flag_size_palette_MWPC);
      palette_MWPC[9] = new TMarker(-5,7,21);      palette_MWPC[9]->SetMarkerColor(kGreen-0);      palette_MWPC[9]->SetMarkerSize(flag_size_palette_MWPC);

      TLatex *tex_palette_MWPC_scale = new TLatex(-4,6,"x 100");               tex_palette_MWPC_scale->SetTextSize(text_size_MWPC);
      tex_palette_MWPC[0] = new TLatex(-4,16,ADC_palette_string_MWPC[0]);      tex_palette_MWPC[0]->SetTextSize(text_size_MWPC);
      tex_palette_MWPC[1] = new TLatex(-4,15,ADC_palette_string_MWPC[1]);      tex_palette_MWPC[1]->SetTextSize(text_size_MWPC);
      tex_palette_MWPC[2] = new TLatex(-4,14,ADC_palette_string_MWPC[2]);      tex_palette_MWPC[2]->SetTextSize(text_size_MWPC);
      tex_palette_MWPC[3] = new TLatex(-4,13,ADC_palette_string_MWPC[3]);      tex_palette_MWPC[3]->SetTextSize(text_size_MWPC);
      tex_palette_MWPC[4] = new TLatex(-4,12,ADC_palette_string_MWPC[4]);      tex_palette_MWPC[4]->SetTextSize(text_size_MWPC);
      tex_palette_MWPC[5] = new TLatex(-4,11,ADC_palette_string_MWPC[5]);      tex_palette_MWPC[5]->SetTextSize(text_size_MWPC);
      tex_palette_MWPC[6] = new TLatex(-4,10,ADC_palette_string_MWPC[6]);      tex_palette_MWPC[6]->SetTextSize(text_size_MWPC);
      tex_palette_MWPC[7] = new TLatex(-4,9,ADC_palette_string_MWPC[7]);       tex_palette_MWPC[7]->SetTextSize(text_size_MWPC);
      tex_palette_MWPC[8] = new TLatex(-4,8,ADC_palette_string_MWPC[8]);       tex_palette_MWPC[8]->SetTextSize(text_size_MWPC);
      tex_palette_MWPC[9] = new TLatex(-4,7,ADC_palette_string_MWPC[9]);       tex_palette_MWPC[9]->SetTextSize(text_size_MWPC);
      ...
      if(selected_TOF2 > 6){
        sprintf(c2_title,"C2 Left   |   Run Number %d   |    Event %d   ", Run_Number, ievt);
        sprintf(c3_title,"C3 Left   |   Run Number %d   |    Event %d   ", Run_Number, ievt);
        sprintf(c4_title,"C4 Left   |   Run Number %d   |    Event %d   ", Run_Number, ievt);
      }
      else{
        sprintf(c2_title,"C2 Right   |   Run Number %d   |    Event %d   ", Run_Number, ievt);
        sprintf(c3_title,"C3 Right   |   Run Number %d   |    Event %d   ", Run_Number, ievt);
        sprintf(c4_title,"C4 Right   |   Run Number %d   |    Event %d   ", Run_Number, ievt);
      }


      tex_Title_MWPC_C2 = new TLatex(-280,16.5,c2_title);
      tex_Title_MWPC_C3 = new TLatex(0,16.5,c3_title);
      tex_Title_MWPC_C4 = new TLatex(0,16.5,c4_title);
      ...
      for(int i = 0; i < C2X_count; i++){
        C2X_line[i] = new TLine(C2_ZLoc[*(C2X_wire_numbers.begin() + i)], -1, C2_ZLoc[*(C2X_wire_numbers.begin() + i)], 16);
      ...
      for(int i = 0; i < C2Y_count; i++){
        C2Y_line[i] = new TLine(-280,*(C2Y_wire_numbers.begin() + i), 280, *(C2Y_wire_numbers.begin() + i));
      ...
      for(int i = 0; i < C3X_count; i++){
        C3X_line[i] = new TLine(*(C3X_wire_numbers.begin() + i), -1, *(C3X_wire_numbers.begin() + i), 16);
      ...
      for(int i = 0; i < C3Y_count; i++){
        C3Y_line[i] = new TLine(-1,*(C3Y_wire_numbers.begin() + i), 64, *(C3Y_wire_numbers.begin() + i));
      ...
      for(int i = 0; i < C4X_count; i++){
        C4X_line[i] = new TLine(*(C4X_wire_numbers.begin() + i), -1, *(C4X_wire_numbers.begin() + i), 16);
      ...
      for(int i = 0; i < C4Y_count; i++){
        C4Y_line[i] = new TLine(-1,*(C4Y_wire_numbers.begin() + i), 72, *(C4Y_wire_numbers.begin() + i));
