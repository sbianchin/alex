...
void Event_Display_5_8(Int_t Run_Number=5, Int_t ievt=0, int walk=0, Int_t enable_cout=0, Int_t display = 0, Int_t graphics = 1){
  ...
  // TGraph *gr_kaon_bk;
  TGraph *gr_kaon_bk = new TGraph(vec_xx_kaon.size(),&vec_xx_kaon[0],&vec_yy_kaon[0]);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 float x_TDC_Gap_Fibers_intersect1=0.;          float y_TDC_Gap_Fibers_intersect1=0.;
  ...
  ofstream fout;
  fout.open("RUN_3994_diagnose_5.6.txt", ios::app);
