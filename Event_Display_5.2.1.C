...
void Event_Display_5_3(Int_t Run_Number=5, Int_t ievt=0, int walk=0, Int_t enable_cout=0, Int_t display = 0){
  ...
  vector <double> vec_ex_lepton_test;       vec_ex_lepton_test.clear();
  vector <double> vec_ey_lepton_test;       vec_ey_lepton_test.clear();
  ...
  for(int i = 0; i<256; i++){
    if(k_stop_bar[i]){
      ...
      vec_ex_kaon.push_back(bar_err);

      vec_yy_kaon.push_back(Yloc[i]);
      vec_ey_kaon.push_back(bar_err);
    }
  }
    ...
    if(TARGET_High_has_neighbours[i]){
      if(ADC_High_TARGET[i]>Angle_ADC_cut && has_TDC_hit[i]){
        if(!k_stop_bar[i]){
          ...
          vec_ex_lepton.push_back(bar_err);

          vec_yy_lepton.push_back(Yloc[i]);
          vec_ey_lepton.push_back(bar_err);

          vec_xx_lepton_test.push_back(Xloc[i]);
          vec_ex_lepton_test.push_back(bar_err);

          vec_yy_lepton_test.push_back(Yloc[i]);
          vec_ey_lepton_test.push_back(bar_err);
      ...
      if(ADC_High_TARGET[i]<0 && ADC_Low_TARGET[i]>0 && Switch==1){
        if(!k_stop_bar[i]){
          vec_xx_lepton.push_back(Xloc[i]);
          vec_xx_lepton.push_back(bar_err);
 ...
 // cout << "//// TOF1 : " << vec_xx_lepton.size() << endl;
  ...
  //     vec_ex_lepton_test.push_back(TOF1_err);

  //     vec_yy_lepton_test.push_back(Gap[gap_to_fit-1][1][1]);
  //     vec_ey_lepton_test.push_back(TOF1_err);
  // }
  ...
  TGraph *gr_test_lepton = new TGraphErrors(vec_xx_lepton_test.size(),&vec_xx_lepton_test[0],&vec_yy_lepton_test[0],
    &vec_ex_lepton_test[0],&vec_ey_lepton_test[0]);
  TGraph *gr_test_kaon = new TGraphErrors(vec_xx_kaon.size(),&vec_xx_kaon[0],&vec_yy_kaon[0],
    &vec_ex_kaon[0],&vec_ey_kaon[0]);
  ...
  if(vec_xx_lepton.size()>0){
    ...
    gr_test_lepton->Fit("pol1","Q");
    gr_test_lepton_fit = gr_test_lepton->GetFunction("pol1");
  ...
  Subplot_1(c2, ch_ADC_cut_TARGET, tex_Legend_TARGET, tex_event_TARGET);
  ...
  for(int i = 0; i<3; i++){
      ...
      vec_ex_lepton.push_back(TOF1_err);

      vec_yy_lepton.push_back(Gap[gap_to_fit-1][1][1]);
      vec_ey_lepton.push_back(TOF1_err);
  }
  ...
  TGraph *gr_Leptons = new TGraphErrors(vec_xx_lepton.size(),&vec_xx_lepton[0],&vec_yy_lepton[0],
    ...
    if(distance_to_line(Xloc[i],Yloc[i],a_fit_TDC_Gap_Fibers,b_fit_TDC_Gap_Fibers) <= max_dist && TARGET_High_has_neighbours[i] && !k_stop_bar[i]){
      if(ADC_High_TARGET[i]>Angle_ADC_cut && has_TDC_hit[i]){
          ...
          if(IsIn(i,channel[gap_to_fit-1][0], channel[gap_to_fit-1][1],
            ...
            vec_xx_lepton_rotate.push_back(Xloc[TARGET_Rotated_index[i]]);
            vec_ex_lepton_rotate.push_back(bar_err);

            vec_yy_lepton_rotate.push_back(Yloc[TARGET_Rotated_index[i]]);
            vec_ey_lepton_rotate.push_back(bar_err);
  ...
  TGraph *gr3_Leptons = new TGraphErrors(vec_xx_lepton.size(),&vec_xx_lepton[0],&vec_yy_lepton[0],
    &vec_ex_lepton[0],&vec_ey_lepton[0]);

  TGraph *gr3_Leptons_test = new TGraphErrors(vec_xx_lepton_test.size(),&vec_xx_lepton_test[0],&vec_yy_lepton_test[0],
    &vec_ex_lepton_test[0],&vec_ey_lepton_test[0]);
