...
void Event_Display_5_4(Int_t Run_Number=5, Int_t ievt=0, int Switch_Printout = 1, int Switch_Display = 1, Int_t enable_cout=0, Int_t batch = 0){
...
*/
  ...
  TGraphErrors gr_kaon = TGraphErrors(vec_xx_kaon.size(),&vec_xx_kaon[0],&vec_yy_kaon[0],
  ...
  if(vec_xx_kaon.size()>=5){
    ...
    TF1 *gr_kaon_fit_ptr = gr_kaon.GetFunction("kaon_fit");
  ...
  if(a_fit_kaon > 1000){
    ...
    TF1 *gr_kaon_fit_ptr = gr_kaon_bk.GetFunction("kaon_fit");
    a_fit_kaon = gr_kaon_fit_ptr->GetParameter(1);
    b_fit_kaon = gr_kaon_fit_ptr->GetParameter(0);
    gr_kaon_fit_ptr->SetLineWidth(2);
    gr_kaon_fit_ptr->SetLineColor(4);
  ...
  TGraphErrors gr_lepton_1 = TGraphErrors(vec_xx_lepton.size(),&vec_xx_lepton[0],&vec_yy_lepton[0],
...
*/
  ...
  TGraphErrors gr_lepton_2 = TGraphErrors(vec_xx_lepton.size(),&vec_xx_lepton[0],&vec_yy_lepton[0],
                                 &vec_ex_lepton[0],&vec_ey_lepton[0]);
  ...
  TGraphErrors gr2_Leptons_rotate = TGraphErrors(vec_xx_lepton_rotate.size(),&vec_xx_lepton_rotate[0],&vec_yy_lepton_rotate[0],
...
*/
  ...
  Chis_lepton_fit_3 = 0.;
  ndf_lepton_fit_3 = 0;
  cout << "vec_xx_lepton points: ";
  for (int i = 0; i < vec_xx_lepton.size(); ++i) cout << vec_xx_lepton[i];
  TGraphErrors gr_lepton_3 = TGraphErrors(vec_xx_lepton.size(),&vec_xx_lepton[0],&vec_yy_lepton[0],
                                         &vec_ex_lepton[0],&vec_ey_lepton[0]);
  ...
  // cout << "Gap to fit: " << gap_to_fit << endl;
  // cout << "Printing non-rotated leptons: " << endl;
  // for (int i = 0; i < vec_xx_lepton.size(); ++i) cout << vec_xx_lepton[i];
  // cout << "Printing rotate leptons: ";
  // for (int i = 0; i < vec_xx_lepton_rotate.size(); ++i) cout << vec_xx_lepton_rotate[i];
  TGraphErrors gr3_Leptons_rotate = TGraphErrors(vec_xx_lepton_rotate.size(),&vec_xx_lepton_rotate[0],&vec_yy_lepton_rotate[0],  // TO MOVE
...
*/
    ...
    gr_lepton_1.GetFunction("Lepton_fit_1")->SetLineWidth(2);
    gr_lepton_1.GetFunction("Lepton_fit_1")->SetLineColor(2);
    ...
    // TCanvas *a_test;
    // a_test = new TCanvas("my test","my test",0,200,1050,700);
    // a_test->Divide(3,2);
    // c2->cd(1);
    // // gr_lepton_3.Draw("ap");
    // TCanvas *a_test;
  ...
  ofstream fout;
  fout.open("output_Batch_5.13.txt", ios::app);
  fout << fixed;
