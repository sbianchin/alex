...
void Event_Display_2_1(Int_t Run_Number=5, Int_t ievt=0, Int_t enable_cout=0, Int_t display_fits = 0){ 
 ...
 /////////////////////////////////////////////////////////////////
  ...
  int kaon_TDC_min = TDC_average - 40;
  int kaon_TDC_max = TDC_average + 20;
