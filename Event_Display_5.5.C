...
uncertainty calculate_uncertainty(double x, double y, double m, double b, double dm, double db, double correlation_coefficient) {
  double dy_squared = pow(x * dm, 2) + pow(db, 2) + 2 * correlation_coefficient * x * dm * db;
  double dx_squared = pow(x * dm / m, 2) + pow(db/m, 2) + 2 * correlation_coefficient * (x/(m*m))*dm*db;
  uncertainty d;
  d.dx = pow(dx_squared,0.5);
  d.dy = pow(dy_squared,0.5);
  return d;
}

bool check_vertical_kaon(vector<double> vec_xx_kaon) {
  bool vertical_kaon = true;
  for (int i = 1; i < vec_xx_kaon.size(); ++i) {
...
void Event_Display_5_5(Int_t Run_Number=5, Int_t ievt=0, int Switch_Printout = 1,
  int Switch_Display = 1, Int_t enable_cout=0, Int_t print_output = 0, Int_t Read_File = 1, Int_t batch=0){
...
*/
  ...
  double correlation_coefficient = gr_lepton_3->GetCorrelationFactor();
...
*/
  ...
  uncertainty d = calculate_uncertainty(x_TARGET_intersect, y_TARGET_intersect, a_lepton_fit_3,
    b_lepton_fit_3, a_lepton_fit_3_error, b_lepton_fit_3_error, correlation_coefficient);
...
*/
  ...
  if (Read_File == 1) {
    ...
    fout << setw(10) << setprecision(5) << a_lepton_fit_3 << "  ";
    fout << setw(10) << setprecision(5) << b_lepton_fit_3 << "  ";
    fout << setw(10) << setprecision(5) << a_lepton_fit_3_error << "  ";
    fout << setw(10) << setprecision(5) << b_lepton_fit_3_error << "  ";
    fout << setw(10) << setprecision(5) << correlation_coefficient << "  ";

    //
    //
    // fout << setw(7) << setprecision(2) << x_TARGET_intersect << "  ";
    // fout << setw(7) << setprecision(2) << y_TARGET_intersect << "  ";
    fout << setw(10) << setprecision(5) << dx << "  ";
    fout << setw(10) << setprecision(5) << dy << "  ";
