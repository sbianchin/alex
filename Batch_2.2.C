...
void Batch_2_2(Int_t Run_Number=5, Int_t ievt_min=2, Int_t ievt_max=2, Int_t Switch_Display=1, Int_t Switch_Zlist=0){ 
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(X_BAR != -10000){
      ...
      if((gap_to_fit_rotate==6 || gap_to_fit_rotate==12 || selected_TOF2==12 || selected_TOF2==6) && Rotate==1){
        ...
        //cout << "DEBUG3 :  " << setw(10) << setprecision(5) << dist_to_k_stop << endl;
    ...
    track_length = distance(X_BAR,Y_BAR,x_tof1_intersect,y_tof1_intersect);
    ...
    if(Switch_Display>0){ 
      ...
      cout << setw(2) << setprecision(0) << ndf << "  ";
      cout << setw(7) << setprecision(3) << X_BAR << "  ";
      cout << setw(7) << setprecision(3) << Y_BAR << "  ";
      cout << setw(7) << setprecision(3) << track_length << "  ";
    ...
    fout << setw(2) << setprecision(0) << ndf << "  ";
    fout << setw(7) << setprecision(3) << X_BAR << "  ";
    fout << setw(7) << setprecision(3) << Y_BAR << "  ";
    fout << setw(7) << setprecision(3) << track_length << "  ";
